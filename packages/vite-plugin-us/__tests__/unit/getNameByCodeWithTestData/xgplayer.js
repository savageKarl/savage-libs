!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ...
      : ((e =
          'undefined' != typeof globalThis ? globalThis : e || self).Player =
          t())
})(this, function () {
  'use strict'
  function e(e, t) {
      ...
      (a.prototype.removeListener = function (e, t, n, o) {
        ...
        if (a.fn)
          ...
          for (var l = 0, c = [], u = a.length; l < u; l++)
            (a[l].fn !== t || (o && !a[l].once) || (n && a[l].context !== n)) &&
              c.push(a[l])
  ...
  var k = m.exports,
    ...
    w = {
      ...
      logInfo: function (e) {
        for (
          var t, i = arguments.length, n = new Array(i > 1 ? i - 1 : 0), o = 1;
          o < i;
          o++
        )
          n[o - 1] = arguments[o]
        this.config.debug >= 3 &&
          (t = console).log.apply(t, [_, C.info, e].concat(n))
      },
      logWarn: function (e) {
        for (
          var t, i = arguments.length, n = new Array(i > 1 ? i - 1 : 0), o = 1;
          ...
          n[o - 1] = arguments[o]
        this.config.debug >= 1 &&
          (t = console).warn.apply(t, [_, C.warn, e].concat(n))
      },
      logError: function (e) {
        var t
  ...
  ;(x.createDom = function () {
    var e =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'div',
    ...
    (x.filterStyleFromText = function (e) {
      ...
      return (
        n.map(function (e) {
          if (e) {
            var i = e.split(':')
            i.length > 1 && (S(i[0], t) ? (o[i[0]] = i[1]) : (r[i[0]] = i[1]))
          }
        }),
    ...
    (x.isMSE = function (e) {
      return (
        !!(e && e instanceof HTMLMediaElement) &&
        (/^blob/.test(e.currentSrc) || /^blob/.test(e.src))
      )
    }),
    (x.isBlob = function (e) {
    ...
    (x.generateSessionId = function () {
      ...
      ;(t += e),
        window.performance &&
          ...
          (t += parseInt(window.performance.now()))
      var i = 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(
        /[xy]/g,
        function (e) {
    ...
    (x.getTransformStyle = function () {
      ...
      return (
        n.forEach(function (e) {
          ...
          n.test(t)
            ? ((n.lastIndex = -1), (t = t.replace(n, o)))
            : (t += ''.concat(o, ' '))
        }),
        t
      )
    }),
    (x.convertDeg = function (e) {
      return Math.abs(e) <= 1 ? 360 * e : e % 360
    }),
    (x.getIndexByTime = function (e, t) {
      var i = t.length,
        n = -1
      if (i < 1) return n
      if (e <= t[0].end || i < 2) n = 0
      else if (e > t[i - 1].end) n = i - 1
      else
        for (var o = 1; o < i; o++)
          if (e > t[o - 1].end && e <= t[o].end) {
            n = o
            break
          }
      return n
    }),
    (x.getOffsetCurrentTime = function (e, t) {
      var i =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : -1,
        n = -1
      if ((n = i >= 0 && i < t.length ? i : x.getIndexByTime(e, t)) < 0)
        return -1
      var o = t.length,
        r = t[n],
        s = r.start,
        ...
        l = r.cTime,
        c = r.offset
      return e < s ? l : e >= s && e <= a ? e - c : e > a && n >= o - 1 ? a : -1
    }),
    (x.getCurrentTimeByOffset = function (e, t) {
      var i = -1
      ...
      if (-1 !== i) {
        var o = t[i].start
        return i - 1 < 0 ? o + e : o + (e - t[i - 1].duration)
      }
      return e
    })
  var L = /(Android)\s([\d.]+)/,
    ...
    O = {
      ...
      get os() {
        ...
        var e = navigator.userAgent,
          ...
          s = r || (n && !/(?:Mobile)/.test(e)) || (o && /(?:Tablet)/.test(e)),
          a = /(?:iPhone)/.test(e) && !s
        return {
          isTablet: s,
          isPhone: a,
      ...
      get osVersion() {
        ...
        var e = navigator.userAgent,
          t = '',
          i = (t = /(?:iPhone)|(?:iPad|PlayBook)/.test(e) ? I : L)
            ? t.exec(e)
            : []
        if (i && i.length >= 3) {
          var n = i[2].split('.')
      ...
      isSupportMP4: function () {
        ...
        return (
          'function' == typeof t.canPlayType &&
            A.map(function (i) {
              'probably' ===
                t.canPlayType('video/mp4; codecs="'.concat(i, '"')) &&
      ...
      isMSESupport: function () {
        ...
        if ('undefined' == typeof MediaSource || !MediaSource) return !1
        try {
          return MediaSource.isTypeSupported(e)
        } catch (t) {
          return this._logger.error(e, t), !1
        }
      },
    ...
    M = { 1: 5101, 2: 5102, 3: 5103, 4: 5104, 5: 5105, 6: 5106 },
    j = r(function e(t) {
      var i =
        arguments.length > 1 && void 0 !== arguments[1]
          ? arguments[1]
      ...
      if (arguments.length > 1) {
        for (
          var v = { playerVersion: R, domain: document.domain },
            y = [
              'errorType',
              'currentTime',
              'duration',
          ...
          v[y[m]] = arguments[m]
        return (v.ex = o ? (o[arguments[0]] || {}).msg : ''), v
      }
    }),
    N = 'play',
    F = 'playing',
    ...
    ne = 'urlNull',
    oe = 'autoplay_started',
    re = 'autoplay_was_prevented',
    se = 'complete',
    ae = 'replay',
    le = 'destroy',
    ce = 'urlchange',
    ue = 'download_speed_change',
    he = 'fullscreen_change',
    de = 'cssFullscreen_change',
    fe = 'mini_state_change',
    pe = 'definition_change',
    ge = 'after_definition_change',
    ve = 'video_resize',
    ye = 'pip_change',
    me = 'rotate',
    ke = 'screenShot',
      ...
      Object.defineProperty(
        {
          ...
          URL_NULL: ne,
          AUTOPLAY_STARTED: oe,
          AUTOPLAY_PREVENTED: re,
          COMPLETE: se,
          REPLAY: ae,
          DESTROY: le,
          URL_CHANGE: ce,
          DOWNLOAD_SPEED_CHANGE: ue,
          FULLSCREEN_CHANGE: he,
          CSS_FULLSCREEN_CHANGE: de,
          MINI_STATE_CHANGE: fe,
          DEFINITION_CHANGE: pe,
          BEFORE_DEFINITION_CHANGE: 'before_definition_change',
          AFTER_DEFINITION_CHANGE: ge,
  ...
  function Ae(e, t) {
    this &&
      this.emit &&
      ('error' === e ? this.errorHandler(e, t.error) : this.emit(e, t))
  }
  function Oe(e, t) {
    return function (i, n) {
      var o = {
      ...
      if (
        ...
        'volumechange' === e &&
          ((o.isMutedChange = t._lastMuted !== t.muted),
  ...
  var Re = (function (e) {
      ...
      function i(e) {
          ...
          (o.mediaConfig = Object.assign(
            {},
            {
              ...
              'x5-video-player-fullscreen':
                e['x5-video-player-fullscreen'] || e.x5VideoPlayerFullscreen,
              'x5-video-orientation':
                e['x5-video-orientation'] || e.x5VideoOrientation,
              airplay: e.airplay,
        ...
        return (
          ...
          e.autoplayMuted &&
            !Object.prototype.hasOwnProperty.call(o.mediaConfig, 'muted') &&
            (o.mediaConfig.muted = !0),
          (o.media = x.createDom(
            o.mediaConfig.mediaType,
            '',
            o.mediaConfig,
            ''
          )),
          e.defaultPlaybackRate &&
            (o.media.defaultPlaybackRate = o.media.playbackRate =
              e.defaultPlaybackRate),
        ...
        r(i, [
              ...
              var e = this,
                t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    : this.media
              this._evHandlers ||
                (this._evHandlers = Ee.map(function (t) {
                  var i = 'on'
                    .concat(t.charAt(0).toUpperCase())
                    .concat(t.slice(1))
                  return (
                    'function' == typeof e[i] && e.on(t, e[i]),
                    s({}, t, Oe(t, e))
                  )
                })),
            ...
            value: function (e, t) {
              ...
              if (n) {
                ;(this._videoSourceCount = n.length),
                  (this._videoSourceIndex = n.length),
                ...
                !this._sourceError &&
                  (this._sourceError = function (e) {
                    ...
                    if (
                      (i._videoSourceIndex--,
                      0 === i._videoSourceIndex || t >= i._videoSourceCount)
                    ) {
                      var n = { code: 4, message: 'sources_load_error' }
                      o ? o.error(e, n) : i.errorHandler('error', n)
                    }
                    var r = D[4]
                    i.emit(
                      xe,
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (t && 0 !== t.length && this._sourceError) {
                ...
                this._vLoadeddata &&
                  e.removeEventListener('loadeddata', this._vLoadeddata)
              }
            }
          },
          {
          ...
          },
          {
            ...
            value: function () {
              for (var e in (this.media &&
                (this.media.pause &&
                  (this.media.pause(), (this.media.muted = !0)),
          ...
          },
          {
            ...
            get: function () {
              return this.media && this.media.buffered
                ? x.getBuffered2(this.media.buffered)
                : null
            }
          },
          {
            ...
            get: function () {
              ...
              for (var i = 0; i < t.length; i++)
                if (
                  (t.start(i) <= this.currentTime || t.start(i) < 0.1) &&
                  t.end(i) >= this.currentTime
                )
          ...
          },
          {
            ...
            set: function (e) {
              this.media &&
                this.media.muted !== e &&
                ((this._lastMuted = this.media.muted), (this.media.muted = e))
            }
          },
          {
            key: 'networkState',
          ...
          },
          {
            ...
            value: function (e, t) {
              for (
                ...
                r[s - 2] = arguments[s]
              ;(n = p(l(i.prototype), 'emit', this)).call.apply(
                n,
                [this, e, t].concat(r)
              )
            }
          },
          {
            ...
            value: function (e, t) {
              for (
                ...
                r[s - 2] = arguments[s]
              ;(n = p(l(i.prototype), 'on', this)).call.apply(
                n,
                [this, e, t].concat(r)
              )
            }
          },
          {
            ...
            value: function (e, t) {
              for (
                ...
                r[s - 2] = arguments[s]
              ;(n = p(l(i.prototype), 'once', this)).call.apply(
                n,
                [this, e, t].concat(r)
              )
            }
          },
          {
            ...
            value: function (e, t) {
              for (
                ...
                r[s - 2] = arguments[s]
              ;(n = p(l(i.prototype), 'off', this)).call.apply(
                n,
                [this, e, t].concat(r)
              )
            }
        ...
        r(e, [
                ...
                (o.onupgradeneeded = function (e) {
                  ...
                  e.target.transaction,
                    t.objectStoreNames.contains(i.myDB.ojstore.name) ||
                      t.createObjectStore(i.myDB.ojstore.name, {
          ...
          },
          {
            ...
            value: function (e, t) {
              for (
                var i,
                  n = this.myDB.db.transaction(e, 'readwrite').objectStore(e),
                  o = 0;
                o < t.length;
                o++
              )
  ...
  function He(e, t, i) {
    for (
      var n = arguments.length, o = new Array(n > 3 ? n - 3 : 0), r = 3;
      r < n;
      r++
    )
      o[r - 3] = arguments[r]
    ...
    return (
      ...
      function () {
        ...
        if (this.__hooks && this.__hooks[e])
          try {
            var s,
              a = (s = this.__hooks[e]).call.apply(
                s,
                [this, this].concat(Array.prototype.slice.call(arguments))
              )
            a
              ? a.then
                ? a
                    .then(function (e) {
                      !1 !== e && He.apply(void 0, [o, t, i.next].concat(g(n)))
                    })
                    .catch(function (e) {
                      throw e
                    })
          ...
          He.apply(
            void 0,
            [this, t, i.next].concat(Array.prototype.slice.call(arguments))
          )
      }.bind(this)
    )
  }
  function Ue(e, t) {
    ...
    if (i)
      return i.hasOwnProperty(e)
        ? (i && (i[e] = t), !0)
        : (console.warn('has no supported hook which name ['.concat(e, ']')),
          !1)
  }
  function Ve(e, t) {
    var i = this.__hooks
  ...
  function Ye(e, t) {
    w.logError(
      '['
        .concat(e, '] event or callback cant be undefined or null when call ')
        .concat(t)
    )
  }
  var Xe = (function () {
        ...
        [
          ...
          },
          {
            ...
            get: function () {
              ...
              return (
                !this.playerConfig ||
                  ('touch' !== this.playerConfig.domEventType &&
                    'mouse' !== this.playerConfig.domEventType) ||
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              e && t && this.player
                ...
                : Ye(this.pluginName, 'plugin.on(event, callback)')
            }
          },
          {
            key: 'once',
            value: function (e, t) {
              ...
              e && t && this.player
                ...
                : Ye(this.pluginName, 'plugin.once(event, callback)')
            }
          },
          {
            key: 'off',
            value: function (e, t) {
              ...
              e && t && this.player
                ...
                : Ye(this.pluginName, 'plugin.off(event, callback)')
            }
          },
          {
            key: 'offAll',
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (this.player)
                return (
                  i && (t.pluginName = i),
                  this.player.registerPlugin({ plugin: e, options: t })
                )
            }
          },
          {
  ...
  if ('undefined' != typeof Element && !Element.prototype.matches) {
    ...
    Ze.matches =
      Ze.matchesSelector ||
      Ze.mozMatchesSelector ||
      Ze.msMatchesSelector ||
      Ze.oMatchesSelector ||
      Ze.webkitMatchesSelector
  }
  var Je = function (e, t) {
    for (; e && 9 !== e.nodeType; ) {
  ...
  function Qe(e, t, i, n) {
    return function (i) {
      ;(i.delegateTarget = Je(i.target, t)), i.delegateTarget && n.call(e, i)
    }
  }
  var et = function (e, t, i, n, o) {
    ...
    tt = { CONTROLS: 'controls', ROOT: 'root' },
    it = {
      ROOT: 'root',
      ROOT_LEFT: 'rootLeft',
  ...
  function rt(e, t) {
    ...
    Object.keys(e).map(function (o) {
      ...
      n &&
        n[o] &&
        ((s = (function (e, t) {
          return 'object' === i(e) && e.class && 'string' == typeof e.class
            ? ''.concat(t, ' ').concat(e.class)
            : t
        })(n[o], s)),
        (a = (function (e, t) {
          return (
        ...
        (l = ot(n[o], o, s, a, t.pluginName))),
        !l && r && (l = ot(r.icon ? r.icon : r, a, s, {}, t.pluginName)),
        (t.icons[o] = l)
    })
  }
  var st = (function (e) {
          ...
          [
              ...
              value: function (e) {
                if ((p(l(o.prototype), '__init', this).call(this, e), e.root)) {
                  ...
                  try {
                    ...
                    throw (
                      (w.logError(
                        'Plugin:'.concat(this.pluginName, ':render'),
                        h
                      ),
                      new Error(
                        'Plugin:'
                          .concat(this.pluginName, ':render:')
                          .concat(h.message)
                      ))
                    )
                  }
                  if (a)
                    (i = o.insert(a, t, e.index)).setAttribute(
                      'data-index',
                      e.index
                    )
                  else {
                    if (!e.tag) return
                    ;(i = x.createDom(e.tag, '', e.attr, e.name)).setAttribute(
                      'data-index',
                      e.index
                    ),
                      t.appendChild(i)
                    ...
                    Object.keys(t).map(function (n) {
                      ...
                      'function' == typeof a
                        ...
                        : 'object' === i(a) &&
                          ...
                          ((o = a.options
                            ? x.deepCopy(e.config[s] || {}, a.options)
                            : e.config[s] || {}),
                          (r = a.plugin)),
                        (l.config = o),
                ...
                t &&
                  (function e(t, i) {
                    for (var n = 0; n < t.children.length; n++)
                      t.children[n].children.length > 0
                        ? e(t.children[n], i)
                        : i(t.children[n])
                  })(t, function (t) {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var n = p(l(o.prototype), 'registerPlugin', this).call(
                  this,
                  e,
                  t,
                  i
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                if (arguments.length < 3 && 'function' == typeof t)
                  ...
                  for (
                    var n = ''.concat(e, '_').concat(t), o = 0;
                    o < this.__delegates.length;
                    o++
                  )
            ...
            },
            {
              ...
              value: function (e, t) {
                this.root &&
                  ((this.root.innerHTML = e), 'function' == typeof t && t())
              }
            },
            {
              key: 'bindEL',
          ...
          [
            {
              ...
              value: function (e, t) {
                ...
                return (
                  r ? t.appendChild(e) : t.insertAdjacentHTML('beforeend', e),
                  t.children[t.children.length - 1]
                )
              }
            },
  ...
  var ct = {
      ...
      checkPlayerRoot: function (e) {
        if (this.pluginGroup) {
          for (
            var t = Object.keys(this.pluginGroup), i = 0;
            i < t.length;
            i++
          ) {
      ...
      formatPluginInfo: function (e, t) {
        var i = null,
          n = null
        return (
          e.plugin && 'function' == typeof e.plugin
            ? ((i = e.plugin), (n = e.options))
            : ((i = e), (n = {})),
          t && (n.config = t || {}),
          { PLUFGIN: i, options: n }
        )
      ...
      checkPluginIfExits: function (e, t) {
        for (var i = 0; i < t.length; i++)
          if (e.toLowerCase() === t[i].pluginName.toLowerCase()) return !0
        return !1
      },
      getRootByConfig: function (e, t) {
        ...
        return 'Object' === x.typeOf(n)
          ? { root: n.root, position: n.position }
          : {}
      },
      ...
      register: function (e, t) {
        ...
        if (e && t && 'function' == typeof t && void 0 !== t.prototype) {
          ...
          if (n && this.pluginGroup[n]) {
            ...
            if (
              !t.isSupported ||
              t.isSupported(e.config.mediaType, e.config.codecType)
            ) {
              i.config || (i.config = {})
              ...
              t.defaultConfig &&
                ...
                i.root
                  ? 'string' == typeof i.root && (i.root = e[i.root])
                  : (i.root = e.root),
      ...
      unRegister: function (e, t) {
        ...
        try {
          ...
          i &&
            (i.pluginName && i.__destroy(),
            delete this.pluginGroup[e]._plugins[t])
        } catch (n) {
          console.error(
            '[unRegister:'.concat(t, '] cgid:[').concat(e, '] error'),
            n
          )
        }
      },
      deletePlugin: function (e, t) {
        ...
        i &&
          this.pluginGroup[i] &&
          this.pluginGroup[i]._plugins &&
          delete this.pluginGroup[i]._plugins[t]
      },
      ...
      beforeInit: function (e) {
        ...
        return new Promise(function (n) {
          if (t.pluginGroup)
            return (
              e._loadingPlugins && e._loadingPlugins.length
                ? Promise.all(e._loadingPlugins)
                : Promise.resolve()
            ).then(function () {
      ...
      reRender: function (e) {
        ...
        if (i && this.pluginGroup[i]) {
          ...
          Object.keys(o).forEach(function (e) {
            'controls' !== e &&
              o[e] &&
              (n.push({ plugin: o[e].func, options: o[e].__args }),
              t.unRegister(i, e))
          }),
      ...
      onPluginsReady: function (e) {
        ...
        if (t && this.pluginGroup[t]) {
          ...
          Object.keys(i).forEach(function (e) {
            i[e].onPluginsReady &&
              'function' == typeof i[e].onPluginsReady &&
              i[e].onPluginsReady()
          })
        }
      },
      setCurrentUserActive: function (e, t) {
        if (this.pluginGroup[e]) {
          ...
          for (
            var i = Object.keys(this.pluginGroup), n = 0;
            n < i.length;
            n++
          ) {
      ...
      getCurrentUseActiveId: function () {
        if (this.pluginGroup) {
          for (
            var e = Object.keys(this.pluginGroup), t = 0;
            t < e.length;
            t++
          ) {
      ...
      destroy: function (e) {
        ...
        if (this.pluginGroup[t]) {
          var i, n
          ;(i = e.root), lt.unObserver(i, n)
          for (
            var o = this.pluginGroup[t]._plugins, r = 0, s = Object.keys(o);
            r < s.length;
            r++
          ) {
            var a = s[r]
  ...
  var dt = 1,
    ...
    bt = (function (e) {
      ...
      function i() {
        ...
        return (
          s(
            u((e = t.call.apply(t, [this].concat(r)))),
            'onMouseEnter',
            function (t) {
              var i = u(e),
                n = i.player
            ...
            },
            {
              ...
              value: function () {
                var e = this,
                  ...
                  o = t.mode
                if (!i) {
                  'flex' === o && this.player.addClass(ut.FLEX_CONTROLS)
                  ...
                  Object.keys(r).map(function (t) {
                    ...
                    this.on(fe, function (t) {
                      t
                        ? x.addClass(e.root, 'mini-controls')
                        : x.removeClass(e.root, 'mini-controls')
                    })
            ...
            },
            {
              ...
              value: function () {
                this.config.autoHide &&
                  x.addClass(this.root, ut.CONTROLS_AUTOHIDE)
              }
            },
            {
              key: 'pauseAutoHide',
              value: function () {
                x.removeClass(this.root, ut.CONTROLS_AUTOHIDE)
              }
            },
            {
              key: 'show',
              ...
              value: function (e) {
                ...
                if (this.root) {
                  ...
                  if (!t.root) {
                    var r = t.position
                      ? t.position
                      : t.config && t.config.position
                        ? t.config.position
                        : o.position
                    switch (r) {
                      case it.CONTROLS_LEFT:
                        t.root = this.left
                        break
                      case it.CONTROLS_RIGHT:
                        t.root = this.right
                        break
                      case it.CONTROLS_CENTER:
                        t.root = this.center
                        break
                      case it.CONTROLS:
                        t.root = this.root
                    ...
                    return p(l(i.prototype), 'registerPlugin', this).call(
                      this,
                      e,
                      t,
                      n
  ...
  function wt() {
    Object.keys(Ct.lang.en).map(function (e) {
      Ct.textKeys[e] = e
    })
  }
  function Tt(e, t) {
    ...
    if ((t || (t = Ct), t.lang)) {
      var n = e.TEXT || {}
      'zh' === i && (i = 'zh-cn'),
        t.lang[i] ? _t(t.lang[i], n) : (t.langKeys.push(i), (t.lang[i] = n)),
        wt()
    }
  }
  Tt({
  ...
  var xt = {
      ...
      get lang() {
        var e = {}
        return (
          Ct.langKeys.map(function (t) {
            e[t] = Ct.lang[t]
          }),
          Ct.lang['zh-cn'] && (e.zh = Ct.lang['zh-cn'] || {}),
          e
        )
      },
      extend: function (e, t) {
        ...
        if ((t || (t = Ct), t.lang)) {
          ...
          i.map(function (e) {
            'zh' === e.LANG && (e.LANG = 'zh-cn'),
              n[e.LANG] ? _t(n[e.LANG] || {}, e.TEXT || {}) : Tt(e, t)
          }),
            wt()
        }
      },
      ...
      init: function (e) {
        ...
        return (
          _t(i.lang, Ct.lang),
          (t = i.langKeys).push.apply(t, g(Ct.langKeys)),
          _t(i.textKeys, Ct.textKeys),
          i
        )
      }
    },
    St = ['play', 'pause', 'replay', 'retry'],
    Et = 0,
    Pt = 0,
    Lt = (function (e) {
      a(o, e)
      ...
      function o(e) {
        ...
        s(u((t = i.call(this, a))), 'canPlayFunc', function () {
          if (t.config) {
            var e = t.config,
              i = e.autoplay,
              n = e.defaultPlaybackRate
            w.logInfo('player', 'canPlayFunc, startTime', t.__startTime),
              t.__startTime > 0 &&
                t.duration > 0 &&
                ((t.currentTime =
                  t.__startTime > t.duration ? t.duration : t.__startTime),
                (t.__startTime = -1)),
              (t.playbackRate = n),
              (i || t._useAutoplay) && t.mediaPlay(),
              t.off(K, t.canPlayFunc),
              t.removeClass(ut.ENTER)
          }
        }),
          s(u(t), 'onFullscreenChange', function (e, i) {
            ...
            if (i || (o && (o === t._fullscreenEl || r)))
              n(),
                ...
                (t.fullscreen = !0),
                t.changeFullStyle(t.root, o, ut.FULLSCREEN),
                t.emit(he, !0, t._fullScreenOffset),
              ...
              s.config.needFullscreenScroll
                ...
                t.cssfullscreen
                  ? t.removeClass(ut.FULLSCREEN)
                  : t.recoverFullStyle(t.root, t._fullscreenEl, ut.FULLSCREEN),
        ...
        if (
          ...
          (t.sizeInfo = { width: 0, height: 0, left: 0, top: 0 }),
          (t._accPlayed = { t: 0, acc: 0, loopAcc: 0 }),
          (t._offsetInfo = { currentTime: -1, duration: 0 }),
          (t.innerContainer = null),
          (t.controls = null),
          (t.topBar = null),
          (t.root = null),
          (t.__i18n = xt.init(t._pluginInfoId)),
          O.os.isAndroid &&
            O.osVersion > 0 &&
            O.osVersion < 6 &&
            (t.config.autoplay = !1),
          (t.database = new De()),
          (t.isUserActive = !1),
          (t._onceSeekCanplay = null),
          (t._isPauseBeforeSeek = 0),
          (t.innerStates = { isActiveLocked: !1 }),
          !t._initDOM())
        )
          return (
            console.error(
        ...
        return (
          ...
          t.onReady && t.onReady(),
          (t.config.videoInit || t.config.autoplay) &&
            (!t.hasStart || t.state < gt) &&
            t.start(),
          t
        )
      }
          ...
          [
            {
              ...
              value: function () {
                ...
                if (
                  (this.media.setAttribute(Fe, this.playerId),
                  this.config.controls)
                ) {
                  var s = this.config.controls.root || null,
                    a = ct.register(this, bt, { root: s })
                  this.controls = a
                }
                var l =
                  'mobile' === this.config.isMobileSimulateMode
                    ? 'mobile'
                    : O.device
                if (
                  (this.addClass(
                    ''
                      .concat(ut.DEFAULT, ' ')
                      .concat(ut.INACTIVE, ' xgplayer-')
                      .concat(l, ' ')
                      .concat(this.config.controls ? '' : ut.NO_CONTROLS)
                  ),
                  this.config.autoplay
                    ? this.addClass(ut.ENTER)
                    : this.addClass(ut.NO_START),
                  this.config.fluid)
                ) {
                  var c = this.config,
                    u = c.width,
                    h = c.height
                  ;('number' == typeof u && 'number' == typeof h) ||
                    ((u = 600), (h = 337.5))
                  var d = {
                    width: '100%',
                    height: '0',
                ...
                var f = this.root.getBoundingClientRect(),
                  p = f.width,
                  g = f.height,
                  v = f.left,
                  y = f.top
                return (
                  (this.sizeInfo.width = p),
                  (this.sizeInfo.height = g),
                  (this.sizeInfo.left = v),
                  (this.sizeInfo.top = y),
                  !0
                )
              }
              ...
              value: function () {
                ...
                ;['focus', 'blur'].forEach(function (t) {
                  ...
                  Me.forEach(function (t) {
                    document &&
                      document.addEventListener(t, e.onFullscreenChange)
                  }),
                  O.os.isIos &&
                  ...
                  this.once(X, this.resize),
                  (this.playFunc = function () {
                    e.config.closeFocusVideoFocus || e.media.focus()
                  }),
                  this.once(N, this.playFunc)
              }
            },
            {
              key: '_unbindEvents',
              value: function () {
                ...
                this.root.removeEventListener('mousemove', this.mousemoveFunc),
                  ...
                  this.playFunc && this.off(N, this.playFunc),
                  this.off(K, this.canPlayFunc),
              ...
              value: function (e) {
                ...
                if (
                  ...
                  this._detachSourceEvents(this.media),
                    'Array' === x.typeOf(e) && e.length > 0
                      ...
                      : this.media.src && this.media.src === e
                        ...
                        : (this.media.src = e),
                    'Number' === x.typeOf(this.config.volume) &&
                  ...
                  w.logInfo('_startInit readyState', n),
                    this.config.autoplay &&
                      (!x.isMSE(this.media) && this.load(),
                      (O.os.isIpad || O.os.isPhone) && this.mediaPlay())
                  var o = this.config.startTime
                  ;(this.__startTime = o > 0 ? o : -1),
                    (this.config.startTime = 0),
                    n >= 2 && this.duration > 0
                      ? this.canPlayFunc()
                      : this.on(K, this.canPlayFunc),
                    (!this.hasStart || this.state < gt) && ct.afterInit(this),
                    (this.hasStart = !0),
                    this.setState(gt),
                    x.setTimeout(
                      this,
              ...
              value: function () {
                ...
                n.forEach(function (i) {
                  try {
                    ...
                    if (i.lazy && i.loader) {
                      var o = ct.lazyRegister(e, i)
                      return void (
                        i.forceBeforeInit &&
                        (o
                          .then(function () {
                            e._loadingPlugins.splice(
                              e._loadingPlugins.indexOf(o),
                              1
                            )
                          })
                          .catch(function (t) {
                ...
                this.config.presets.forEach(function (t) {
                  !(function (e, t) {
                    var i,
                      ...
                      o =
                        t.preset && t.options
                          ? new t.preset(t.options, e.config)
                          : new t({}, e.config),
                      r = o.plugins,
                      s = void 0 === r ? [] : r,
                      a = o.ignores,
            ...
            },
            {
              ...
              value: function (e) {
                ...
                switch (e) {
                  case it.ROOT_RIGHT:
                    this.rightBar ||
                      (this.rightBar = x.createPositionBar(
                        'xg-right-bar',
                        this.root
                      )),
                      (t = this.rightBar)
                  ...
                  case it.ROOT_LEFT:
                    this.leftBar ||
                      (this.leftBar = x.createPositionBar(
                        'xg-left-bar',
                        this.root
                      )),
                      (t = this.leftBar)
                  ...
                  case it.ROOT_TOP:
                    this.topBar ||
                      ((this.topBar = x.createPositionBar(
                        'xg-top-bar',
                        this.root
                      )),
                      this.config.topBarAutoHide &&
                        x.addClass(this.topBar, ut.TOP_BAR_AUTOHIDE)),
                      (t = this.topBar)
                    break
                  default:
            ...
            },
            {
              key: 'registerPlugin',
              value: function (e, t) {
                var i = ct.formatPluginInfo(e, t),
                  n = i.PLUFGIN,
                  o = i.options,
                  r = this.config.plugins
                !ct.checkPluginIfExits(n.pluginName, r) && r.push(n)
                var s = ct.getRootByConfig(n.pluginName, this.config)
                s.root && (o.root = s.root),
                  s.position && (o.position = s.position)
                var a = o.position
                  ? o.position
                  : (o.config && o.config.position) ||
                    (n.defaultConfig && n.defaultConfig.position)
                return !o.root &&
                  'string' == typeof a &&
                  a.indexOf('controls') > -1
                  ? this.controls &&
                      this.controls.registerPlugin(n, o, n.pluginName)
                  : (o.root || (o.root = this._getRootByPosition(a)),
                    ct.register(this, n, o))
              }
            },
            {
              key: 'deregister',
              value: function (e) {
                'string' == typeof e
                  ? ct.unRegister(this, e)
                  : e instanceof Xe && ct.unRegister(this, e.pluginName)
              }
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  ('string' == typeof e
                    ? (t = e)
                    : e instanceof Xe && (t = e.pluginName),
                  t)
                )
                  for (var i = this.config.plugins.length - 1; i > -1; i--) {
                    if (
                      this.config.plugins[i].pluginName.toLowerCase() ===
                      t.toLowerCase()
                    ) {
            ...
            },
            {
              key: 'plugins',
              get: function () {
                return ct.getPlugins(this)
              }
            },
            {
              key: 'getPlugin',
              value: function (e) {
                var t = ct.findPlugin(this, e)
            ...
            },
            {
              ...
              value: function (e) {
                this.root &&
                  (x.hasClass(this.root, e) || x.addClass(this.root, e))
              }
            },
            {
              key: 'removeClass',
                    ...
                    ct
                      ...
                      .then(function () {
                        if (t.config) {
                          ...
                          var i = t.preProcessUrl(e)
                          return t._startInit(i.url)
                        }
                      })
                      .catch(function (e) {
                        throw (
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                'Object' === x.typeOf(e) && (n = e.url),
                  (n = this.preProcessUrl(n).url)
                var o = this.currentTime
                this.__startTime = o
                var r = this.paused && !this.isError
                return (
                  (this.src = n),
                  new Promise(function (e, t) {
                    var o = function (e) {
                        i.off('timeupdate', s), i.off('canplay', s), t(e)
                      },
                      s = function () {
                        i.duration > 0 &&
                          i.__startTime > 0 &&
                          ((i.currentTime = i.__startTime),
                          (i.__startTime = -1)),
                          r && i.pause(),
                          i.off('error', o),
                          e(!0)
            ...
            },
            {
              ...
              value: function () {
                var e = this
                if (!this.hasStart && this.state < gt)
                  return (
                    this.removeClass(ut.NO_START),
                    this.addClass(ut.ENTER),
                    this.start(),
                ...
                this.state < yt &&
                  (this.removeClass(ut.NO_START),
                  !this.isCanplay && this.addClass(ut.ENTER))
                var t = p(l(o.prototype), 'play', this).call(this)
                return (
                  void 0 !== t && t && t.then
                    ? t
                        .then(function () {
                          e.removeClass(ut.NOT_ALLOW_AUTOPLAY),
                            e.addClass(ut.PLAYING),
                            e.state < yt &&
                              (w.logInfo('>>>>playPromise.then'),
                              e.setState(yt),
                              e.emit(oe))
                        })
                        .catch(function (t) {
                          if (
                            (w.logWarn('>>>>playPromise.catch', t.name),
                            e.media && e.media.error)
                          )
                            return e.onError(), void e.removeClass(ut.ENTER)
                          'NotAllowedError' === t.name &&
                            (e._errorTimer = x.setTimeout(
                              ...
                              function () {
                                ;(e._errorTimer = null),
                                  e.emit(re),
                                  e.addClass(ut.NOT_ALLOW_AUTOPLAY),
                                  e.removeClass(ut.ENTER),
                                  e.pause(),
                                  e.setState(vt)
                              },
                              0
                    ...
                    : (w.logWarn('video.play not return promise'),
                      this.state < yt &&
                        (this.setState(yt),
                        this.removeClass(ut.NOT_ALLOW_AUTOPLAY),
                        this.removeClass(ut.NO_START),
                        this.removeClass(ut.ENTER),
                        this.addClass(ut.PLAYING),
                        this.emit(oe))),
                  t
                )
              }
                  ...
                  ;(e =
                    e < 0
                      ...
                      : e > this.duration
                        ...
                        : e),
                    !this._isPauseBeforeSeek &&
                      (this._isPauseBeforeSeek = this.paused ? 2 : 1),
                    this._onceSeekCanplay && this.off(G, this._onceSeekCanplay),
                    (this._onceSeekCanplay = function () {
                      switch (
                        (i.removeClass(ut.ENTER), (i.isSeeking = !1), s)
                      ) {
                        case 'play':
                          i.play()
                          break
                        case 'pause':
                          ...
                          break
                        default:
                          i._isPauseBeforeSeek > 1 || i.paused
                            ? i.pause()
                            : i.play()
                      }
                      ;(i._isPauseBeforeSeek = 0), (i._onceSeekCanplay = null)
                    }),
                    this.once(G, this._onceSeekCanplay),
                    this.state < yt
                      ? (this.removeClass(ut.NO_START),
                        (this.currentTime = e),
                        this.play())
              ...
              value: function () {
                ...
                !t.url &&
                  ...
                  i.list.map(function (t) {
                    t.definition === i.defaultDefinition &&
                      ((e.config.url = t.url), (e.curDefinition = t))
                  })
              }
            },
            {
                ...
                if (
                  (Array.isArray(null == o ? void 0 : o.list) &&
                    o.list.forEach(function (t) {
                      ;(null == e ? void 0 : e.definition) === t.definition &&
                        (n.curDefinition = t)
                    }),
                  null != e &&
                    e.bitrate &&
                    'number' != typeof e.bitrate &&
                    (e.bitrate = parseInt(e.bitrate, 10) || 0),
                  ...
                  r && r.then
                    ? r.then(function () {
                        n.emit(ge, { from: i, to: e })
                      })
                    : this.emit(ge, { from: i, to: e })
              ...
              value: function () {
                ...
                if (i && n) {
                  ...
                  !t &&
                    ...
                    i.contains(n) &&
                    i.removeChild(n),
                    ['topBar', 'leftBar', 'rightBar', 'innerContainer'].map(
                      function (t) {
            ...
            },
            {
              ...
              value: function () {
                var e = this
                this.removeClass(ut.ENDED),
                  (this.currentTime = 0),
                  (this.isSeeking = !1),
                  qe(this, 'replay', function () {
                    e.once(G, function () {
                      var t = e.mediaPlay()
                      t &&
                        t.catch &&
            ...
            },
            {
              ...
              value: function () {
                var e = this
                this.removeClass(ut.ERROR),
                  this.addClass(ut.LOADING),
                  qe(this, 'retry', function () {
                    var t = e.currentTime,
                      i = e.config.url,
                      n = x.isMSE(e.media) ? { url: i } : e.preProcessUrl(i)
                    ;(e.src = n.url),
            ...
            },
            {
              ...
              value: function (e, t, i, n) {
                e &&
                  (n || (n = ut.PARENT_FULLSCREEN),
                  this._orgCss || (this._orgCss = x.filterStyleFromText(e)),
                  x.addClass(e, i),
                  t &&
                    t !== e &&
                    !this._orgPCss &&
                    ((this._orgPCss = x.filterStyleFromText(t)),
                    x.addClass(t, n),
                    t.setAttribute(Fe, this.playerId)))
              }
            },
            {
              ...
              value: function (e, t, i, n) {
                n || (n = ut.PARENT_FULLSCREEN),
                  this._orgCss &&
                    (x.setStyleFromCsstext(e, this._orgCss),
                    (this._orgCss = '')),
                  x.removeClass(e, i),
                  t &&
                    t !== e &&
            ...
            },
            {
              ...
              value: function (e) {
                if (
                  (this.isRotateFullscreen && this.exitRotateFullscreen(),
              ...
              value: function () {
                var e =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                    : this.config.fullscreenTarget
                this.isRotateFullscreen
                  ? this.exitRotateFullscreen()
                  : this.fullscreen && this.exitFullscreen()
                var t = e
                  ? ''
                      .concat(ut.INNER_FULLSCREEN, ' ')
                      .concat(ut.CSS_FULLSCREEN)
                  : ut.CSS_FULLSCREEN
                this.changeFullStyle(this.root, e, t)
                var i = this.config.fullscreen,
                  n = void 0 === i ? {} : i,
                  o =
                    !0 === n.useCssFullscreen ||
                    ('function' == typeof n.useCssFullscreen &&
                      n.useCssFullscreen())
                o && ((this.fullscreen = !0), this.emit(he, !0)),
              ...
              value: function () {
                ...
                if (this.fullscreen) {
                  var t = this.config.fullscreen,
                    i = void 0 === t ? {} : t
                  !0 === i.useCssFullscreen ||
                  ('function' == typeof i.useCssFullscreen &&
                    i.useCssFullscreen())
                    ? (this.recoverFullStyle(
                        this.root,
                        this._cssfullscreenEl,
                        e
                      ),
                      (this.fullscreen = !1),
                      this.emit(he, !1))
            ...
            },
            {
              ...
              value: function () {
                ...
                var t = e
                  ? ''
                      .concat(ut.INNER_FULLSCREEN, ' ')
                      .concat(ut.ROTATE_FULLSCREEN)
                  : ut.ROTATE_FULLSCREEN
                ;(this._fullscreenEl = e || this.root),
                  this.changeFullStyle(
                    this.root,
                    e,
                    t,
                    ut.PARENT_ROTATE_FULLSCREEN
                  ),
            ...
            },
            {
              ...
              value: function () {
                ...
                this.isActive
                  ...
                  : this.emit(
                      ee,
                      t({ paused: this.paused, ended: this.ended }, e)
                    )
              }
            },
            {
              ...
              value: function () {
                var e = this,
                  t =
                    arguments.length > 0 && void 0 !== arguments[0]
                      ? arguments[0]
                      : { autoHide: !0, delay: 3e3 },
                  i = this.innerStates
                if (
                  ((this.isActive = !0),
                  this.removeClass(ut.INACTIVE),
                  this.userTimer &&
                    (x.clearTimeout(this, this.userTimer),
                    (this.userTimer = null)),
                  void 0 !== t.isLock && (i.isActiveLocked = t.isLock),
                  !1 === t.autoHide || !0 === t.isLock || i.isActiveLocked)
                )
                  this.userTimer &&
                    (x.clearTimeout(this, this.userTimer),
                    (this.userTimer = null))
                else {
                  var n = t && t.delay ? t.delay : this.config.inactive
            ...
            },
            {
              ...
              value: function () {
                ...
                if (this.isActive && !this.innerStates.isActiveLocked) {
                  ...
                  ;(this.isActive = !1),
                    (i || n || (!this.paused && !this.ended)) &&
                      this.addClass(ut.INACTIVE)
                }
              }
            },
            {
            ...
            },
            {
              key: 'onLoadeddata',
              value: function () {
                ;(this.isError = !1), (this.isSeeking = !1)
              }
            },
            {
              key: 'onLoadstart',
              value: function () {
                this.removeClass(ut.ERROR), (this.isCanplay = !1)
              }
            },
            {
              key: 'onPlay',
              value: function () {
                this.state === mt && this.setState(yt),
                  this.removeClass(ut.PAUSED),
                  this.ended && this.removeClass(ut.ENDED),
            ...
            },
            {
              ...
              value: function () {
                !this._videoHeight && this.media.videoHeight && this.resize(),
                  (this.waitTimer || this.hasClass(ut.LOADING)) &&
            ...
            },
            {
              ...
              value: function (e) {
                ...
                for (
                  var i = e || this.media.currentTime || 0.2,
                    n = t.length,
                    o = 0;
                  o < n;
                  o++
            ...
            },
            {
              ...
              value: function () {
                var e = this.videoPos,
                  ...
                  r = e.w
                if (!(t < 0) || i || n) {
                  var s = this.videoPos._pi
                  if (
                    (!s &&
                      this.media.videoHeight &&
                      (s =
                        (this.media.videoWidth / this.media.videoHeight) * 100),
                    s)
                  ) {
                    this.videoPos.pi = s
                    var a = { rotate: t },
                      ...
                      y = p
                    if (h % 2 == 0)
                      (u = o > 0 ? 100 / o : r > 0 ? 100 / r : 1),
                        (a.scale = u),
                        (l = i > 0 ? (100 - o) / 2 - i : 0),
                        (a.y = 2 === h ? 0 - l : l),
                        (c = n > 0 ? (100 - r) / 2 - n : 0),
                        (a.x = 2 === h ? 0 - c : c),
                        (this.media.style.width = ''.concat(y, 'px')),
                        (this.media.style.height = ''.concat(v, 'px'))
                    else if (h % 2 == 1) {
                      v = p
                      var m = g - p
                      ;(c = (-m / 2 / (y = g)) * 100),
                    ...
                    var k = x.getTransformStyle(
                      a,
                      this.media.style.transform ||
                        this.media.style.webkitTransform
                    )
                    ;(this.media.style.transform = k),
                      (this.media.style.webkitTransform = k)
                  }
                }
              }
            },
              ...
              value: function () {
                ...
                if (this.media) {
                  ...
                  var i = this.media,
                    ...
                    a = r.videoFillMode
                  if (
                    (('fill' !== a && 'cover' !== a && 'contain' !== a) ||
                      this.setAttribute('data-xgfill', a),
                    o && n)
                  ) {
                    ;(this._videoHeight = o), (this._videoWidth = n)
                    var l =
                    ...
                    this.resizePosition(), this.emit(ve, v)
                  }
                }
              }
            },
            {
              ...
              value: function () {
                ...
                this.media.updateObjectPosition
                  ...
                  : (this.media.style.objectPosition = ''
                      .concat(100 * e, '% ')
                      .concat(100 * t, '%'))
              }
            },
            {
              ...
              value: function (e) {
                w.logInfo(
                  'setState',
                  'state from:'.concat(kt[this.state], ' to:').concat(kt[e])
                ),
                  (this._state = e)
              }
            },
            {
              key: 'preProcessUrl',
              value: function (e, t) {
                var i = this.config.preProcessUrl
                return !x.isBlob(e) && i && 'function' == typeof i
                  ? i(e, t)
                  : { url: e }
              }
            },
            ...
            },
            {
              key: 'isPlaying',
              get: function () {
                return this._state === yt || this._state === mt
              },
              set: function (e) {
                e ? this.setState(yt) : this._state >= yt && this.setState(gt)
              }
            },
            {
              key: 'definitionList',
              ...
              set: function (e) {
                ...
                ;(i.list = e),
                  ...
                  e.forEach(function (e) {
                    var r
                    ;(null === (r = t.curDefinition) || void 0 === r
                      ? void 0
                      : r.definition) === e.definition && (n = e),
              ...
              get: function () {
                ...
                return (
                  ...
                  e.total > 0 &&
                    ...
                    (e.droppedDuration = parseInt(
                      (this.cumulateTime / e.total) * e.dropped,
                      0
                    ))),
                  e
                )
            ...
            },
            {
              ...
              set: function (e) {
                0 !==
                  xt.langKeys.filter(function (t) {
                    return t === e
                  }).length || 'zh' === e
                  ? ((this.config.lang = e), ct.setLang(e, this))
                  : console.error(
                      'Sorry, set lang fail, because the language ['
                        .concat(
                          e,
                          '] is not supported now, list of all supported languages is ['
                        )
                        .concat(xt.langKeys.join(), '] ')
                    )
              }
            },
            {
            ...
            },
            {
              ...
              get: function () {
                var e = this._accPlayed,
                  t = e.acc,
                  i = e.t
                return i ? new Date().getTime() - i + t : t
              }
            },
            {
              key: 'zoom',
            ...
            },
            {
              ...
              set: function (e) {
                ;(e = x.convertDeg(e)) % 90 == 0 &&
                  e !== this.videoPos.rotate &&
                  ((this.videoPos.rotate = e), this.resizePosition())
              }
            },
            {
              key: 'avgSpeed',
              ...
              value: function (e, t, i) {
                for (
                  var n = arguments.length,
                    o = new Array(n > 3 ? n - 3 : 0),
                    r = 3;
                  r < n;
                  r++
                )
                  o[r - 3] = arguments[r]
                return Ge.call.apply(
                  Ge,
                  [this].concat(Array.prototype.slice.call(arguments))
                )
              }
            ...
            },
            {
              ...
              value: function (e, t) {
                'boolean' == typeof t &&
                  t !== this.muted &&
                  (this.addInnerOP('volumechange'), (this.muted = t)),
                  ct.setCurrentUserActive(this.playerId, e)
              }
            }
          ],
          [
            ...
            },
            {
              ...
              value: function () {
                return ct.getCurrentUseActiveId()
              }
            },
            {
              key: 'setCurrentUserActive',
              value: function (e, t) {
                ct.setCurrentUserActive(e, t)
              }
            },
            {
              key: 'isHevcSupported',
  ...
  s(Lt, 'defaultPreset', null), s(Lt, 'XgVideoProxy', null)
  function It() {
  ...
  var At = 'loadstart',
    ...
    Ft = (function (e) {
      ...
      function o() {
        ...
        return (
          s(
            u((e = i.call.apply(i, [this].concat(r)))),
            '_onTimeupdate',
            function () {
          ...
          s(u(e), '_onAutoplayStart', function () {
            w.logInfo(
              '[xgLogger]'.concat(e.player.playerId, ' _onAutoplayStart')
            ),
          ...
          s(u(e), '_onSeeking', function () {
            e.seekingStart ||
              (e.suspendWaitingStatus('seek'),
              (e.seekingStart = It()),
              e.emitLog(jt, { start: It() }))
          }),
        ...
        r(
          ...
          [
                ...
                this._onReset(),
                  ...
                  this.on($, function () {
                    var t = e._state,
                      i = t.autoplayStart,
                      n = t.isFFSend
                    ;(e.startCostTime = It() - e.newPointTime),
                      w.logInfo(
                  ...
                  this.on(V, this._onSeeking),
                  this.on(G, this._onSeeked),
                  this.on(le, function () {
                    e.endState('destroy')
                  }),
                  this.on(ce, function () {
                    e.endState('urlChange'),
                      w.logInfo(
                        '[xgLogger]'.concat(e.player.playerId, ' URL_CHANGE')
                      ),
                      e._state.isFFSend && e._onReset()
                  }),
                  this.on([F, K], this._onPlaying),
                  this.on(z, this._onWaiting),
                  this.on(U, this._onError),
                  this.on(Te, function () {
            ...
            },
            {
              key: '_initOnceEvents',
              value: function () {
                this.off(oe, this._onAutoplayStart),
            ...
            },
            {
              ...
              value: function (e) {
                if (this.seekingStart) {
                  ...
                  ;(this.seekingStart = 0),
                    this.emitLog(Nt, { end: t, costTime: i, endType: e })
                }
              }
            },
            {
              ...
              value: function (e) {
                if (
                  (this._waitTimer &&
                    (x.clearTimeout(this, this._waitTimer),
                    (this._waitTimer = null)),
                  this._waittTimer &&
                    (x.clearTimeout(this, this._waittTimer),
        ...
        r(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                var e = this
                st.insert(this.icons.replay, this.root, 0),
                  ...
                  this.on(H, function () {
                    if (
                      (e.playerConfig.loop ||
                        x.addClass(e.player.root, 'replay'),
                      !e.config.disable)
                    ) {
                      e.show()
        ...
        r(
          ...
          [
            ...
            },
            {
              key: 'beforeCreate',
              value: function (e) {
                'string' == typeof e.player.config.poster &&
                  (e.config.poster = e.player.config.poster)
              }
            },
            {
              key: 'afterCreate',
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return t ? 'background-size: '.concat(t, ';') : ''
              }
            },
            {
              key: 'render',
              value: function () {
                var e = this.config,
                  ...
                  n = e.fillMode,
                  o = this.getBgSize(n),
                  r = t ? 'background-image:url('.concat(t, ');').concat(o) : o
  ...
  function zt(e) {
    e
      ...
      : Object.keys(Wt).map(function (e) {
          window.clearTimeout(Wt[e].id), delete Wt[e]
        })
  }
  var Kt = (function (e) {
      a(i, e)
      ...
      function i(e) {
        ...
        return (
          n(this, i),
          s(u((o = t.call(this, e))), 'onPlayerReset', function () {
            o.autoPlayStart = !1
            var e = 'auto' === o.config.mode ? 'auto-hide' : 'hide'
            o.setAttr('data-state', 'play'), x.removeClass(o.root, e), o.show()
          }),
          s(u(o), 'onAutoplayStart', function () {
            if (!o.autoPlayStart) {
              var e = 'auto' === o.config.mode ? 'auto-hide' : 'hide'
              x.addClass(o.root, e),
                (o.autoPlayStart = !0),
          ...
          [
            {
              ...
              value: function () {
                ...
                this.initIcons(),
                  ...
                  this.on(oe, this.onAutoplayStart),
            ...
            },
            {
              ...
              value: function () {
                return {
                  startPlay: { icon: Vt, class: 'xg-icon-play' },
                  startPause: { icon: Gt, class: 'xg-icon-pause' }
                }
              }
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                var t = this
                this._animateId = (function (e, t) {
                  var i =
                    arguments.length > 2 && void 0 !== arguments[2]
                      ? arguments[2]
                      : { start: null, end: null }
                  return (
                    Wt[e] && window.clearTimeout(Wt[e].id),
                    (Wt[e] = {}),
                    i.start && i.start(),
                    (Wt[e].id = window.setTimeout(function () {
                      i.end && i.end(),
                        window.clearTimeout(Wt[e].id),
                        delete Wt[e]
                    }, t)),
                    Wt[e].id
                  )
            ...
            },
            {
              key: 'endAnimate',
              value: function () {
                x.removeClass(this.root, 'interact'),
                  zt(this._animateId),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                e.stopPropagation(),
                t.state < ft) ||
                  (this.player.paused || t.state !== yt ? t.play() : t.pause())
              }
            },
            {
              key: 'onPlayPause',
              value: function (e) {
                var t = this.config,
                  i = this.player
                if (i && !(i.state < yt) && this.autoPlayStart) {
                  if ('show' === t.mode)
                    return this.switchStatus(), void this.show()
                  if ('auto' !== t.mode) {
                    if (
                      (t.isShowPause && i.paused && !i.ended) ||
                      (t.isShowEnd && i.ended)
                    )
                      return (
                        this.switchStatus(), this.show(), void this.endAnimate()
                      )
                    if (t.disableAnimate)
                      return this.switchStatus(), void this.hide()
                    if ('play' === e)
            ...
            },
            {
              key: 'render',
              value: function () {
                var e = this.playerConfig.autoplay
                  ? 'auto' === this.config.mode
                    ? 'auto-hide'
                    : 'hide'
                  : ''
          ...
          [
            {
              ...
              value: function () {
                ...
                if (e && e instanceof window.HTMLElement) t.appendChild(e)
                  ...
                  t.innerHTML = '<div class="xgplayer-enter-spinner">'.concat(
                    i,
                    '</div>'
                  )
                }
      ...
      r(
        ...
        [
          ...
          },
          {
            key: 'defaultConfig',
            get: function () {
              return { position: it.CONTROLS_RIGHT, index: 10 }
            }
          }
        ]
      ),
  ...
  function Qt(e) {
    if (
      ...
      for (
        var o = (n.isBorderBox = 'border-box' === t.boxSizing), r = 0;
        r < $t;
        r++
      ) {
        var s = Jt[r],
    ...
    ri = (function (e) {
      ...
      function i(e) {
        ...
        return (
          ...
          (o._handlerDom =
            r.handle instanceof Element
              ? r.handle
              : document.querySelector(r.handle)),
        ...
        r(i, [
          {
            ...
            value: function () {
              ...
              'ontouchstart' in window
                ...
                (this['on'.concat(this._startKey)] =
                  this['on'.concat(this._startKey)].bind(this)),
                this._handlerDom.addEventListener(
                  this._startKey,
                  this['on'.concat(this._startKey)]
                ),
                oi[this._startKey].map(function (t) {
          ...
          },
          {
            ...
            value: function () {
              this._handlerDom.removeEventListener(
                this._startKey,
                this['on'.concat(this._startKey)]
              )
            }
          ...
          },
          {
            key: 'ontouchmove',
            value: function (e) {
              var t = ei(e.changedTouches, this.touchIdentifier)
              t && this.dragMove(e, t)
            }
          },
          {
          ...
          },
          {
            ...
            value: function (e, t) {
              if (-1 !== e.indexOf('%')) {
                var i = Qt(this._root.parentNode)
          ...
          s(u(o), 'onScroll', function (e) {
            if (
              !(
                ...
                Math.abs(window.scrollY - o.pos.scrollY) < 50
              )
            ) {
              ...
              ;(t += o.config.scrollTop),
                ...
                window.scrollY > t + 5
                  ...
                  : window.scrollY <= t &&
                    (o.isMini && o.exitMini(), (o.isClose = !1))
            }
          }),
          (o.isMini = !1),
          (o.isClose = !1)
          ...
          [
            {
              key: 'beforeCreate',
              value: function (e) {
                'boolean' == typeof e.player.config.mini &&
                  (e.config.isShowIcon = e.player.config.mini)
              }
            },
            {
              key: 'afterCreate',
              ...
              value: function () {
                ...
                if (!this.config.disable) {
                  if (this.config.isShowIcon) {
                    ...
                    t.controls.registerPlugin(Xt, i, Xt.pluginName)
                  }
                  ...
                  this.bind('.mini-cancel-btn', n, this.onCancelClick),
                    ...
                    this.config.disableDrag ||
                      (this._draggabilly = new ri(this.player.root, {
                        handle: this.root
                      })),
                    this.config.isScrollSwitch &&
            ...
            },
            {
              ...
              value: function () {
                return {
                  play: { icon: Vt, class: 'xg-icon-play' },
                  pause: { icon: Gt, class: 'xg-icon-pause' }
                }
              }
            },
            {
              ...
              value: function () {
                ...
                x.removeClass(t.root, 'xgplayer-mini'),
                  ...
                  i.fluid &&
                    ...
                    (t.root.style['padding-top'] = ''.concat(
                      (100 * i.height) / i.width,
                      '%'
                    ))),
                  this.emit(fe, !1),
              ...
              value: function () {
                if (!this.config.disable)
                  return '\n      <xg-mini-layer class="xg-mini-layer">\n      <xg-mini-header class="xgplayer-mini-header">\n      '.concat(
                    Yt(this, 'MINI_DRAG', this.playerConfig.isHideTips),
        ...
        return (
          s(
            ...
            function (t) {
              var i = u(e),
                ...
                o = i.playerConfig
              n.isActive ||
                (n.focus({ autoHide: !o.closeDelayBlur }),
          ...
          s(u(e), 'onMouseEnter', function (t) {
            ...
            !n.closeFocusVideoFocus && o.media.focus(),
              n.closeDelayBlur ? o.focus({ autoHide: !1 }) : o.focus()
          }),
          s(u(e), 'onMouseLeave', function (t) {
            ...
            n ||
              r ||
              (o ? e.player.focus({ autoHide: !0, delay: o }) : e.player.blur())
          }),
          ...
          s(u(e), 'onVideoDblClick', function (t) {
            var i = u(e),
              n = i.player,
              o = i.playerConfig
            o.closeVideoDblclick ||
              !t.target ||
              (t.target !== n.media && t.target !== n.media.__canvas) ||
              (!o.closeVideoClick && e._clickCount < 2
                ? (e._clickCount = 0)
                : ((e._clickCount = 0),
                  e.clickTimer &&
                    (clearTimeout(e.clickTimer), (e.clickTimer = null)),
            ...
            },
            {
              ...
              value: function () {
                ...
                n && n.addEventListener('click', this.onVideoClick, !1),
                  ...
                  Object.keys(ai).map(function (t) {
                    n.addEventListener(t, e[ai[t]], !1)
                  }),
                  !o &&
                    i &&
                    i.addEventListener('contextmenu', this.onContextmenu, !1)
              }
            },
            {
              key: 'switchPlayPause',
              value: function (e) {
                ...
                this.emitUserAction(e, 'switch_play_pause', {
                  ...
                  t.ended
                    ? t.duration !== 1 / 0 && t.duration > 0 && t.replay()
                    : t.paused
                      ? t.play()
                      : t.pause()
              }
            ...
            },
            {
              ...
              value: function () {
                ...
                this.clickTimer && clearTimeout(this.clickTimer),
                  ...
                  Object.keys(ai).map(function (t) {
                    n.removeEventListener(t, e[ai[t]], !1)
                  })
              }
            }
          ],
      ...
      n(this, e),
        s(this, 'onTouchStart', function (e) {
          var t = i._pos,
            n = i.root,
            o = ki(e.touches)
          ;(t.x = o ? parseInt(o.pageX, 10) : e.pageX),
            (t.y = o ? parseInt(o.pageX, 10) : e.pageX),
            (t.start = !0),
            i.__setPress(e),
            n.addEventListener(i.events.end, i.onTouchEnd),
            n.addEventListener(i.events.cancel, i.onTouchCancel),
            n.addEventListener(i.events.move, i.onTouchMove),
            i.trigger(gi, e)
        }),
        s(this, 'onTouchCancel', function (e) {
          i.onTouchEnd(e)
        }),
        s(this, 'onTouchEnd', function (e) {
          var t = i._pos,
            n = i.root
          i.__clearPress(),
            n.removeEventListener(i.events.cancel, i.onTouchCancel),
            n.removeEventListener(i.events.end, i.onTouchEnd),
            n.removeEventListener(i.events.move, i.onTouchMove),
            (e.moving = t.moving),
            (e.press = t.press),
            t.press && i.trigger(hi, e),
            i.trigger(vi, e),
            !t.press && !t.moving && i.__setDb(e),
            (t.press = !1),
            (t.start = !1),
            (t.moving = !1)
        }),
        s(this, 'onTouchMove', function (e) {
          var t = i._pos,
            n = i.config,
            o = ki(e.touches),
            r = o ? parseInt(o.pageX, 10) : e.pageX,
            s = o ? parseInt(o.pageY, 10) : e.pageX,
            a = r - t.x,
            l = s - t.y
          ;(Math.abs(l) < n.miniStep && Math.abs(a) < n.miniStep) ||
            (i.__clearPress(),
            t.press && i.trigger(hi, e),
            (t.press = !1),
            (t.moving = !0),
        ...
        (this.root = t),
        (this.events = 'mouse' === o.eventType ? mi : yi),
      ...
      r(e, [
          ...
          value: function (e) {
            ...
            this.pressIntrvalId && this.__clearPress(),
              (this.pressIntrvalId = setTimeout(function () {
                t.trigger(ui, e), (t._pos.press = !0), t.__clearPress()
              }, i.pressDelay))
          }
        },
        {
        ...
        },
        {
          ...
          value: function (e) {
            var t = this,
              i = this.config
            if (this.dbIntrvalId)
              return this.__clearDb(), void this.trigger(di, e)
        ...
        },
        {
          ...
          value: function () {
            ...
            Object.keys(t).forEach(function (i) {
              e.root.removeEventListener(i, e[t[i]])
            })
          }
        }
      ]),
        ...
        return (
          ...
          s(u((o = t.call(this, e))), 'onTouchStart', function (e) {
            ...
            if (a && !n.disableGesture && o.duration > 0 && !i.ended) {
              ;(r.isStart = !0),
                x.checkIsFunction(s.disableSwipeHandler) &&
                  s.disableSwipeHandler(),
            ...
            if (n.isStart) {
              ...
              !a && l
                ? (o.endLastMove(n.scope),
                  setTimeout(function () {
                    i.getPlugin('progress') &&
                      i.getPlugin('progress').resetSeekState()
                  }, 10))
                : (n.time = 0),
                (n.scope = -1),
                o.resetPos(),
                x.checkIsFunction(r.enableSwipeHandler) &&
          ...
          s(u(o), 'onRootTouchEnd', function (e) {
            o.pos.isStart &&
              o.checkIsRootTarget(e) &&
              (e.stopPropagation(), o.onTouchEnd(e))
          }),
          (o.pos = {
            isStart: !1,
            x: 0,
        ...
        r(
          ...
          [
            ...
            },
            {
              key: 'registerIcons',
              value: function () {
                return { seekTipIcon: { icon: Ci, class: 'xg-seek-pre' } }
              }
            },
            {
              key: 'afterCreate',
              value: function () {
                ...
                !0 === t.closeVideoDblclick && (i.closedbClick = !0),
                  this.resetPos(),
                  x.isUndefined(t.disableGesture) ||
                    (i.disableGesture = !!t.disableGesture),
                ...
                var o = 'mouse' === this.domEventType ? 'mouse' : 'touch'
                ;(this.touch = new bi(this.root, {
                  eventType: o,
                  ...
                  this.on(q, function () {
                    var t = e.player,
                      i = e.config
                    1e3 * t.duration < i.moveDuration &&
                      (i.moveDuration = 1e3 * t.duration)
                  }),
                  this.on([K, H], function () {
                    var t = e.pos,
                      i = t.time
            ...
            },
            {
              ...
              value: function () {
                var e = (this.playerConfig || {}).commonStyle,
                  ...
                  i = e.progressColor
                t &&
                  ((this.find('.xg-curbar').style.backgroundColor = t),
                  (this.find('.xg-cur').style.color = t)),
                  i &&
                    ((this.find('.xg-bar').style.backgroundColor = i),
                    (this.find('.time-preview').style.color = i)),
                  this.config.disableTimeProgress &&
                    x.addClass(this.find('.xg-timebar'), 'hide')
              }
            },
            {
              key: 'resetPos',
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return (
                  ...
                  ((t.start && t.start.root.contains(e.target)) ||
                    (t.controls && t.controls.root.contains(e.target)))
                )
              }
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                t.state < yt
                  ? n.closeVideoClick ||
                    (this.sendUseAction(x.createEvent('click')), t.play())
                  : !i.closedbClick || n.closeVideoClick
                    ...
                    : n.closeVideoClick ||
                      ((t.isActive || i.focusVideoClick) &&
                        (this.sendUseAction(x.createEvent('click')),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                !t.closedbClick &&
                  i.state >= yt &&
                  (this.sendUseAction(x.createEvent('dblclick')),
                  this.switchPlayPause())
              }
            },
            {
                ...
                ;(o =
                  (o += this.pos.time) < 0
                    ...
                    : o > 1e3 * n
                      ...
                      : o),
                  t.getPlugin('time') &&
                    t.getPlugin('time').updateTime(o / 1e3),
                  t.getPlugin('progress') &&
                    t
                      .getPlugin('progress')
                      .updatePercent(o / 1e3 / this.duration, !0),
                  this.activeSeekNote(o / 1e3, e > 0),
                  i.isTouchingSeek &&
                    t.seek(Number((o - this.timeOffset) / 1e3).toFixed(1)),
                  (this.pos.time = o)
              }
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  ...
                  var n =
                    parseInt(10 * t.volume, 10) - parseInt(i.volume / 10, 10)
                  ;(n = n > 10 ? 10 : n < 1 ? 0 : n),
                    (t.volume = n / 10),
                    (i.volume = 0)
                }
            ...
            },
            {
              ...
              value: function (e) {
                ...
                t &&
                  t.usable &&
                  this.thumbnail &&
                  t.update(this.thumbnail, e, 160, 90)
              }
            },
            {
              key: 'switchPlayPause',
          ...
          function (t) {
            if (e.player) {
              var i = t || window.event,
                ...
                a = e.config,
                l = a.disable,
                c = a.disableBodyTrigger,
                h = a.isIgnoreUserActive
              l ||
              c ||
              (!s.isUserActive && !h) ||
              Ei(i.target) ||
              ...
              i.ctrlKey
                ...
                : (t.repeat ||
                    ...
                    ((i.target === document.body ||
                      (e.config.isGlobalTrigger && !Ei(i.target))) &&
                      e.checkCode(n, !0) &&
                      (r.isBodyKeyDown = !0),
                    document.addEventListener('keyup', e.onBodyKeyUp)),
                  r.isBodyKeyDown && e.handleKeyDown(i))
            }
          }
        ),
        s(u(e), 'onBodyKeyUp', function (t) {
          e.player &&
            (document.removeEventListener('keyup', e.onBodyKeyUp),
            e.handleKeyUp(t))
        }),
          ...
          if (e.player) {
            ...
            if (!i.repeat) {
              ...
              !i ||
                ...
                (i.target !== e.player.root &&
                  i.target !== e.player.video &&
                  i.target !== e.player.controls.el) ||
                (n.isKeyDown = !0),
                e.player.root.addEventListener('keyup', e.onKeyup)
            }
            n.isKeyDown && e.handleKeyDown(i)
          }
        }),
        s(u(e), 'onKeyup', function (t) {
          e.player &&
            (e.player.root.removeEventListener('keyup', e.onKeyup),
            e.handleKeyUp(t))
        }),
        e
      )
        ...
        [
          ...
          },
          {
            ...
            value: function () {
              ...
              var e =
                'function' == typeof this.config.seekStep
          ...
          },
          {
            ...
            value: function (e) {
              var t = this.player
              if (!(t.volume <= 0)) {
                var i = parseFloat((t.volume - 0.1).toFixed(1)),
                  n = { volume: { from: t.volume, to: i } }
                this.emitUserAction(e, 'change_volume', { props: n }),
                  (t.volume = i >= 0 ? i : 0)
              }
            }
          },
          ...
          },
          {
            ...
            value: function (e) {
              var t = this.player,
                ...
                l = r || o,
                c =
                  e.repeat && this.seekStep >= 4
                    ? parseInt(this.seekStep / 2, 10)
                    : this.seekStep
              a + c <= l ? (a += c) : (a = l)
              var u = x.getCurrentTimeByOffset(a, s),
                h = { currentTime: { from: i, to: u } }
              this.emitUserAction(e, 'seek', { props: h }),
                (this.player.currentTime = u)
            }
          },
          {
            key: 'seekBack',
            value: function (e) {
              var t = this.player,
                ...
                r =
                  (n > -1 ? n : i) -
                  (e.repeat ? parseInt(this.seekStep / 2, 10) : this.seekStep)
              r < 0 && (r = 0)
              var s = {
                currentTime: {
                  from: i,
                  to: (r = x.getCurrentTimeByOffset(r, o))
                }
              }
              this.emitUserAction(e, 'seek', { props: s }),
          ...
          },
          {
            ...
            value: function (e) {
              var t = this._keyState,
                i = this.config,
                n = this.player
              0 === t.playbackRate &&
                ((t.playbackRate = n.playbackRate),
                (n.playbackRate = i.playbackRate))
            }
          },
          {
            key: 'playPause',
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (e.repeat) {
                t.isPress = !0
                var i = Date.now()
                if (i - t.tt < 200) return
                t.tt = i
              }
              this.handleKeyCode(e.keyCode, e, t.isPress)
            }
          },
          {
            key: 'handleKeyUp',
          ...
          },
          {
            ...
            value: function (e, i, n) {
              for (
                var o, r = Object.keys(this.keyCodeMap), s = 0;
                s < r.length;
                s++
              ) {
                var a = this.keyCodeMap[r[s]],
                  l = a.action,
                  c = a.keyCode,
                  u = a.disable,
                  h = a.pressAction,
                ...
                if (c === e) {
                  if (!(u || (n && d))) {
                    ...
                    'function' == typeof f
                      ? l(i, this.player, n)
                      : 'string' == typeof f &&
                        'function' == typeof this[f] &&
                        this[f](i, this.player, n),
                      this.emit(
                        Ce,
                        t(
                          { key: r[s], target: i.target, isPress: n },
                          this.keyCodeMap[r[s]]
                        )
                      )
                  }
                  ;(o = i).preventDefault(), (o.returnValue = !1)
                  break
                }
              }
            }
  ...
  var Ii = (function (e) {
        ...
        r(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (e < t.length)
                return (
                  x.addClass(t[e], this.fragConfig.fragFocusClass),
                  { dom: t[e], pos: t[e].getBoundingClientRect() }
                )
            }
          },
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                if (
                  ((this.fragments =
                    0 === e.fragments.length ? [{ percent: 1 }] : e.fragments),
              ...
              if (
                ...
                this.progressList = this.fragments.map(function (i) {
                  var r = x.createDom(
                    ...
                    {
                      style: t
                        ? 'background:'.concat(t, '; flex: ').concat(i.percent)
                        : 'flex: '.concat(i.percent)
                    },
                    ''
                      .concat(i.isFocus ? o : '', ' xgplayer-progress-inner ')
                      .concat(n)
                  )
                  return (
    ...
    Ri = { POINT: 'inner-focus-point', HIGHLIGHT: 'inner-focus-highlight' },
    Di = (function (e) {
      a(l, e)
      var o = d(l)
      function l(e) {
        ...
        return (
          ...
          s(u(t), 'onBodyClick', function (e) {
            t.pos.isLocked &&
              ((t.pos.isLocked = !1), e.preventDefault(), e.stopPropagation())
          }),
          s(u(t), '_mouseDownHandler', function (e, i) {
            ;(t._state.time = i.currentTime),
              t.updateWidth(i.currentTime, i.seekTime, i.percent, 0),
              t._updateInnerFocus(i)
          }),
          s(u(t), '_mouseUpHandler', function (e, i) {
            u(t).pos.moving &&
              t.updateWidth(i.currentTime, i.seekTime, i.percent, 2)
          }),
          s(u(t), '_mouseMoveHandler', function (e, i) {
            ...
            o.time < i.currentTime ? (i.forward = !0) : (i.forward = !1),
              ...
              t.updateWidth(i.currentTime, i.seekTime, i.percent, 1),
          ...
          s(u(t), 'onMouseDown', function (e) {
            ...
            if (
              !(
                o.isMini ||
                s.closeMoveSeek ||
                (!a.allowSeekAfterEnded && o.ended)
              )
            ) {
              if (o.duration || o.isPlaying) {
                e.stopPropagation(),
                  t.focus(),
                  x.checkIsFunction(a.disableSwipeHandler) &&
                    a.disableSwipeHandler(),
          ...
          s(u(t), 'onMouseUp', function (e) {
            ...
            ;(l.prePlayTime = a.prePlayTime),
              r.moving
                ? (t.triggerCallbacks('dragend', l, e),
                  t.emitUserAction('drag', 'dragend', l))
                : (t.triggerCallbacks('click', l, e),
          ...
          s(u(t), 'onMouseMove', function (e) {
            ...
            if (
              !(
                (o.moving && c < s.miniMoveStep) ||
                (!o.moving && c < s.miniStartStep)
              )
            ) {
              o.x = l
          ...
          s(u(t), 'onMouseEnter', function (e) {
            ...
            if (
              !(
                ...
                o.isEnter ||
                n.isMini ||
                (!n.config.allowSeekAfterEnded && n.ended)
              )
            ) {
              ;(o.isEnter = !0),
                t.bind('mousemove', t.onMoveOnly),
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                ...
                this.innerList
                  ...
                  : ((this.innerList = new Oi(o)),
                    this.outer.insertBefore(
                      this.innerList.render(),
                      this.outer.children[0]
                    ),
                    [
                      'findHightLight',
                      'unHightLight',
              ...
              value: function () {
                ...
                if (!this.config.disable && !this.playerConfig.isLive) {
                  ...
                  this._initInner(this.config.fragments, {
                    ...
                    'mobile' === O.device &&
                      ((this.config.isDragingSeek = !1), (this.isMobile = !0)),
                  ...
                  this.__dragCallBacks.map(function (n) {
                    if (n && n.handler && n.type === e)
                      try {
                        ...
                        console.error(
                          '[XGPLAYER][triggerCallbacks] '.concat(n, ' error'),
                          o
                        )
                      }
                  })
            ...
            },
            {
              ...
              value: function (e, t) {
                t &&
                  'function' == typeof t &&
                  this.__dragCallBacks.push({ type: e, handler: t })
              }
            },
            {
              key: 'removeCallBack',
            ...
            },
            {
              ...
              value: function () {
                var e = this.player,
                  t = e.controls,
                  i = e.config
                ;(this._mouseDownHandlerHook = this.hook(
                  'dragstart',
                  this._mouseDownHandler
                )),
                  (this._mouseUpHandlerHook = this.hook(
                    'dragend',
                    this._mouseUpHandler
                  )),
                  (this._mouseMoveHandlerHook = this.hook(
                    'drag',
                    this._mouseMoveHandler
                  )),
                  ('touch' !== this.domEventType &&
                    'compatible' !== this.domEventType) ||
                    (this.root.addEventListener('touchstart', this.onMouseDown),
                    t &&
                      (t.root &&
                        t.root.addEventListener('touchmove', x.stopPropagation),
                      t.center &&
                        t.center.addEventListener(
                          'touchend',
                          x.stopPropagation
                        ))),
                  ('mouse' !== this.domEventType &&
                    'compatible' !== this.domEventType) ||
                    (this.bind('mousedown', this.onMouseDown),
                    'mobile' !== i.isMobileSimulateMode &&
                      this.bind('mouseenter', this.onMouseEnter),
            ...
            },
            {
              ...
              value: function (e, t, i, n) {
                var o = this.config,
                  r = this.player
                if (!o.isCloseClickSeek || 0 !== n) {
                  var s = (t =
                    t >= r.duration
                      ? r.duration - o.endedDiff
                      : Number(t).toFixed(1))
                  this.updatePercent(i),
                    this.updateTime(e),
                    (1 !== n ||
                      (o.isDragingSeek && 'audio' !== r.config.mediaType)) &&
                      ((this._state.now = s),
                      (this._state.direc = s > r.currentTime ? 0 : 1),
                      r.seek(s))
                }
              }
            },
            {
              ...
              value: function (e, t) {
                ...
                var h = u - n,
                  d = (h = h > i ? i : h < 0 ? 0 : h) / i
                d = d < 0 ? 0 : d > 1 ? 1 : d
                var f = parseInt(d * this.offsetDuration * 1e3, 10) / 1e3
                return {
                  percent: d,
                  currentTime: f,
                  seekTime: x.getCurrentTimeByOffset(f, o.timeSegments),
                  offset: h,
                  width: i,
                  left: n,
                  e: e
            ...
            },
            {
              ...
              value: function (e) {
                var t = this.player,
                  i = this._state,
                  n = this.offsetDuration
                if (
                  !(
                    (t.isSeeking && t.media.seeking) ||
                  ...
                  if (i.now > -1) {
                    var o =
                      parseInt(1e3 * i.now, 10) -
                      parseInt(1e3 * t.currentTime, 10)
                    if (
                      (0 === i.direc && o > 300) ||
                      (1 === i.direc && o > -300)
                    )
                  ...
                  ;(r = x.adjustTimeByDuration(r, n, e)),
                    ...
                    (this.progressBtn.style.left = ''.concat(
                      (r / n) * 100,
                      '%'
                    ))
              ...
              value: function (e) {
                ...
                if (t) {
                  ...
                  ;(n = x.adjustTimeByDuration(n, i, e)),
                    this.innerList.update({ cached: n }, i)
        ...
        r(
              ...
              value: function (e) {
                ...
                return (
                  ...
                  t.ended
                    ? t.replay()
                    : t.paused
                      ? (t.play(), this.animate(!1))
                      : (t.pause(), this.animate(!0)),
                  !1
                )
              }
            },
                ...
                if (this.player) {
                  ...
                  e
                    ? (this.setAttr('data-state', 'pause'),
                      i && this.changeLangTextKey(i, t.PLAY_TIPS))
              ...
              value: function () {
                if (!this.config.disable)
                  return '<xg-icon class="xgplayer-play">\n    <div class="xgplayer-icon">\n    </div>\n    '.concat(
                    Yt(this, 'PLAY_TIPS', this.playerConfig.isHideTips),
                    '\n    </xg-icon>'
                  )
              }
            }
          ...
          [
            ...
            },
            {
              key: 'defaultConfig',
              get: function () {
                return { position: it.CONTROLS_LEFT, index: 0, disable: !1 }
              }
            }
          ]
        ),
      ...
      r(
        ...
        [
          ...
          },
          {
            key: 'registerIcons',
            value: function () {
              return { screenBack: { icon: Ni, class: 'xg-fullscreen-back' } }
            }
          },
          {
            key: 'initIcons',
        ...
        [
          ...
          },
          {
            key: 'defaultConfig',
            get: function () {
              return { position: it.ROOT_TOP, index: 0 }
            }
          }
        ]
      ),
          ...
          [
            {
              ...
              value: function () {
                ...
                if (!t.disable) {
                  ...
                  n.fullscreenTarget === o &&
                    this.player.getFullscreen().catch(function (e) {}),
                    this.initIcons(),
                    (this.handleFullscreen = this.hook(
                      'fullscreenChange',
                    ...
                    this.on(he, function (t) {
                      ...
                      i &&
                        e.changeLangTextKey(
                          i,
                          t
                            ? e.i18nKeys.EXITFULLSCREEN_TIPS
                            : e.i18nKeys.FULLSCREEN_TIPS
                        ),
                        e.animate(t)
                    }),
            ...
            },
            {
              ...
              value: function () {
                return {
                  fullscreen: { icon: Hi, class: 'xg-get-fullscreen' },
                  exitFullscreen: { icon: Bi, class: 'xg-exit-fullscreen' }
                }
              }
            },
            {
              ...
              value: function () {
                p(l(i.prototype), 'destroy', this).call(this),
                  this.unbind(
                    '.xgplayer-icon',
                    'mobile' === O.device ? 'touchend' : 'click',
                    this.handleFullscreen
                  ),
                  'mobile' === O.device &&
              ...
              value: function (e) {
                ...
                ('function' == typeof i.useCssFullscreen &&
                  ...
                  ? (t.fullscreen
                      ? t.exitCssFullscreen()
                      : t.getCssFullscreen(),
                    this.animate(t.fullscreen))
                  : i.rotateFullscreen
                    ? (t.fullscreen
                        ? t.exitRotateFullscreen()
                        : t.getRotateFullscreen(),
                      this.animate(t.fullscreen))
            ...
            },
            {
              ...
              value: function (e) {
                e
                  ...
                  this.topBackIcon &&
                    (e
                      ? (this.topBackIcon.show(), this.hide())
                      : (this.topBackIcon.hide(), this.show()))
              }
            },
            {
              key: 'show',
              ...
              value: function () {
                if (!this.config.disable) {
                  return '<xg-icon class="xgplayer-fullscreen">\n    <div class="xgplayer-icon">\n    </div>\n    '.concat(
                    Yt(this, 'FULLSCREEN_TIPS', this.playerConfig.isHideTips),
                    '\n    </xg-icon>'
                  )
                }
              }
        ...
        r(
          ...
          [
            {
              ...
              get: function () {
                var e = this.player,
                  t = e.offsetDuration,
                  i = e.duration
                return this.playerConfig.customDuration || t || i
              }
            },
            {
              key: 'currentTime',
              ...
              value: function () {
                ...
                ;(this.mode = 'flex' === t ? 'flex' : 'normal'),
                  this.config.disable ||
                    ...
                    this.on([q, G, W], function (t) {
                      'durationchange' === t.eventName && (e.isActiving = !1),
                        e.onTimeUpdate()
                    }),
                    this.on(H, function () {
                      e.onTimeUpdate(!0)
            ...
            },
            {
              ...
              value: function () {
                if ('flex' === this.mode)
                  return (
                    this.centerCurDom &&
                      (this.centerCurDom.style.display = 'block'),
                    void (
                      this.centerDurDom &&
                      (this.centerDurDom.style.display = 'block')
                    )
                  )
                this.root.style.display = 'block'
              }
            },
            {
              ...
              value: function () {
                if ('flex' === this.mode)
                  return (
                    this.centerCurDom &&
                      (this.centerCurDom.style.display = 'none'),
                    void (
                      this.centerDurDom &&
                      (this.centerDurDom.style.display = 'none')
                    )
                  )
                this.root.style.display = 'none'
              }
            },
            {
              ...
              value: function (e) {
                ...
                if (!i.disable && !this.isActiving && t.hasStart) {
                  var o = this.currentTime + this.timeOffset
                  ;(o = x.adjustTimeByDuration(o, n, e)),
                    'flex' === this.mode
                      ? ((this.centerCurDom.innerHTML = this.minWidthTime(
                        ...
                        n !== 1 / 0 &&
                          n > 0 &&
                          (this.centerDurDom.innerHTML = x.format(n)))
                      : ((this.timeDom.innerHTML = this.minWidthTime(
                          x.format(o)
                        )),
                        n !== 1 / 0 &&
                          n > 0 &&
                          (this.durationDom.innerHTML = x.format(n)))
                }
              }
            },
            {
              ...
              value: function () {
                'flex' === this.mode
                  ? ((this.centerCurDom.innerHTML = this.minWidthTime(
                    ...
                    (this.centerDurDom.innerHTML = x.format(0)))
                  : ((this.timeDom.innerHTML = this.minWidthTime(x.format(0))),
            ...
            },
            {
              ...
              value: function () {
                ...
                if (e.controls && e.controls.center) {
                  ...
                  ;(this.centerCurDom = x.createDom(
                    'xg-icon',
                    '00:00',
                    {},
                    'xgplayer-time xg-time-left'
                  )),
                    (this.centerDurDom = x.createDom(
                      'xg-icon',
                      '00:00',
                      {},
            ...
            },
            {
              ...
              value: function (e) {
                return e
                  .split(':')
                  .map(function (e) {
                    return '<span class="time-min-width">'.concat(e, '</span>')
                  })
                  .join(':')
              }
            },
          ...
          [
            ...
            },
            {
              key: 'defaultConfig',
              get: function () {
                return { position: it.CONTROLS_LEFT, index: 2, disable: !1 }
              }
            }
          ]
        ),
          ...
          s(
            ...
            function () {
              ...
              var t = e.player,
                i = t.currentTime,
                n = t.timeSegments
              if (e._checkIfEnabled(n)) {
                var o = x.getIndexByTime(i, n),
                  r = x.getOffsetCurrentTime(i, n, o)
                ;(e.player.offsetCurrentTime = r), e.changeIndex(o, n)
              }
            }
          ),
          s(u(e), '_onLoadedData', function () {
            var t = e.player.timeSegments
            if (e._checkIfEnabled(t)) {
              var i = x.getOffsetCurrentTime(0, t)
              ;(e.player.offsetCurrentTime = i),
                e.changeIndex(0, t),
                e.curPos.start > 0 && (e.player.currentTime = e.curPos.start)
            }
          }),
          s(u(e), '_onTimeupdate', function () {
            var t = e.player,
              i = t.currentTime,
              n = t.timeSegments
            if (e._checkIfEnabled(n)) {
              var o = n.length
              e.lastCurrentTime = i
              var r = x.getIndexByTime(i, n)
              r !== e.curIndex && e.changeIndex(r, n)
              var s = x.getOffsetCurrentTime(i, n, r)
              if (((e.player.offsetCurrentTime = s), e.curPos)) {
                var a = e.curPos,
                  l = a.start,
                  c = a.end
                i < l
                  ? (e.player.currentTime = l)
                  : i > c && r >= o - 1 && e.player.pause()
              }
            }
          }),
          s(u(e), '_onSeeking', function () {
            var t = e.player,
              ...
              n = t.timeSegments
            if (e._checkIfEnabled(n))
              if (i < n[0].start) e.player.currentTime = n[0].start
              else if (i > n[n.length - 1].end)
                e.player.currentTime = n[n.length - 1].end
              else {
                var o = x.getIndexByTime(i, n)
                if (o >= 0) {
                  var r = e.getSeekTime(i, e.lastCurrentTime, o, n)
                  r >= 0 && (e.player.currentTime = r)
                }
              }
          }),
          s(u(e), '_onPlay', function () {
            var t = e.player,
              i = t.currentTime,
              n = t.timeSegments
            e._checkIfEnabled(n) &&
              i >= n[n.length - 1].end &&
              (e.player.currentTime = n[0].start)
          }),
          e
        )
      }
          ...
          [
            {
              ...
              value: function () {
                ;(this.curIndex = -1),
                  ...
                  this.updateSegments(),
                  this.on(q, this._onDurationChange),
                  this.on(X, this._onLoadedData),
                  this.on(W, this._onTimeupdate),
                  this.on(V, this._onSeeking),
                  this.on(N, this._onPlay)
              }
            },
            {
              key: 'setConfig',
            ...
            },
            {
              ...
              value: function () {
                ...
                if (t || !i || 0 === i.length)
                  (n.timeSegments = []),
                    (n.offsetDuration = 0),
                    (n.offsetCurrentTime = -1)
                else {
                  var o = this.formatTimeSegments(i, n.duration)
                  ;(n.timeSegments = o),
                    (n.offsetDuration =
                      o.length > 0 ? o[o.length - 1].duration : 0)
                }
              }
            },
            {
                ...
                return e
                  ? (e.sort(function (e, t) {
                    ...
                    e.forEach(function (e, n) {
                      var o = {}
                      if (
                        ((o.start = e.start < 0 ? 0 : e.start),
                        (o.end = t > 0 && e.end > t ? t : e.end),
                        !(t > 0 && o.start > t))
                      ) {
                        i.push(o)
                        var r = o.end - o.start
                        if (0 === n)
                          ...
                          var s = i[n - 1]
                          ;(o.offset = s.offset + (o.start - s.end)),
                            (o.cTime = s.duration + s.cTime),
                            (o.segDuration = r),
                            (o.duration = s.duration + r)
                        }
                      }
                    }),
                    i)
            ...
            },
            {
              ...
              value: function (e, t, i, n) {
                ...
                if (l < 0 && e < s) {
                  var c = t > s ? t - s : 0
                  return (o = i - 1 >= 0 ? n[i - 1].end + l + c : 0)
                }
                return -1
              }
            },
        ...
        s(u(e), 'onVolumeChange', function (t) {
          if (e.player) {
            var i = e.player,
              ...
              o = i.volume
            e._d.isMoving ||
              ((e.find('.xgplayer-drag').style.height =
                n || 0 === o ? '4px' : ''.concat(100 * o, '%')),
        ...
        [
          {
            ...
            value: function () {
              return {
                volumeSmall: { icon: zi, class: 'xg-volume-small' },
                volumeLarge: { icon: Wi, class: 'xg-volume' },
                volumeMuted: { icon: Ki, class: 'xg-volume-mute' }
              }
            }
          },
          {
            ...
            value: function () {
              ...
              if (
                ((this._timerId = null),
                (this._d = { isStart: !1, isMoving: !1, isActive: !1 }),
                !this.config.disable)
              ) {
                this.initIcons()
                var t = this.playerConfig,
                  ...
                  n = t.volume
                i.volumeColor &&
                  (this.find('.xgplayer-drag').style.backgroundColor =
                    i.volumeColor),
                  ...
                  (this._onMouseenterHandler = this.hook(
                    'mouseenter',
                    this.onMouseenter
                  )),
                  (this._onMouseleaveHandler = this.hook(
                    'mouseleave',
                    this.onMouseleave
                  )),
                  'mobile' !== O.device &&
                  ...
                  this.on(Y, this.onVolumeChange),
                  this.once(X, this.onVolumeChange),
                  'Number' !== x.typeOf(n) &&
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (o && n) {
                var r = parseInt(
                  (e / o.getBoundingClientRect().height) * 1e3,
                  10
                )
          ...
          },
          {
            ...
            value: function () {
              this.player.focus({ autoHide: !1 }),
                this._timerId &&
                  (x.clearTimeout(this, this._timerId), (this._timerId = null)),
            ...
            value: function () {
              if (!this.config.disable) {
                ...
                return '\n    <xg-icon class="xgplayer-volume" data-state="normal">\n      <div class="xgplayer-icon">\n      </div>\n      <xg-slider class="xgplayer-slider">\n        '
                  .concat(
                    t
                      ? '<div class="xgplayer-value-label">'.concat(
                          100 * e,
                          '</div>'
                        )
                      : '',
        ...
        [
          {
            ...
            value: function () {
              ...
              if (!this.config.disable) {
                ...
                var t = this.player.root
                ;(this.rootWidth =
                  t.style.width || t.offsetWidth || t.clientWidth),
                  (this.rootHeight =
                    t.style.height || t.offsetHeight || t.clientHeight),
                  this.rotateDeg &&
                    this.updateRotateDeg(
                      this.rotateDeg,
                      this.config.innerRotate
                    )
              }
            }
          },
          ...
          },
          {
            key: 'updateRotateDeg',
            value: function (e, t) {
              if ((e || (e = 0), t)) this.player.videoRotateDeg = e
              else {
                var i = this.player,
                  n = this.rootWidth,
                  o = this.rootHeight,
                  ...
                  a = i.media,
                  l = r.offsetWidth,
                  c = s && t ? s.offsetHeight : r.offsetHeight,
                  u = n,
                  h = o,
                  d = 0,
                  f = 0
                ...
                var p = 'translate('
                  ...
                  v = t ? a : r,
                  y = t ? i.getPlugin('poster') : null
                Object.keys(g).map(function (e) {
                  ;(v.style[e] = g[e]), y && y.root && (y.root.style[e] = g[e])
                })
              }
            }
          },
            ...
            value: function () {
              if (!this.config.disable)
                return '\n    <xg-icon class="xgplayer-rotate">\n      <div class="xgplayer-icon">\n      </div>\n      '.concat(
                  Yt(this, 'ROTATE_TIPS', this.playerConfig.isHideTips),
                  '\n    </xg-icon>'
                )
            }
          }
        ...
        r(
          ...
          [
            {
              key: 'beforeCreate',
              value: function (e) {
                'boolean' == typeof e.player.config.pip &&
                  (e.config.showIcon = e.player.config.pip)
              }
            },
            {
              key: 'afterCreate',
            ...
            },
            {
              ...
              value: function () {
                return {
                  pipIcon: { icon: Zi, class: 'xg-get-pip' },
                  pipIconExit: { icon: Ji, class: 'xg-exit-pip' }
                }
              }
            },
            {
              ...
              value: function () {
                ...
                ;(this.leavePIPCallback = function () {
                  ...
                  (this.onWebkitpresentationmodechanged = function (i) {
                    ...
                    e.pMode === en &&
                      n !== en &&
                      t.onFullscreenChange(null, !1),
                      (e.pMode = n),
                      n === $i
                        ? e.enterPIPCallback(i)
                        : n === Qi && e.leavePIPCallback(i)
                  }),
                  t.media &&
                ...
                if (this.isPIPAvailable() && !this.isPip)
                  try {
                    ...
                    return (
                      n &&
                        (e.media.poster =
                          'String' === x.typeOf(n) ? n : n.poster),
                      i.checkWebkitSetPresentationMode(e.media)
                        ? e.media.webkitSetPresentationMode(
                            'picture-in-picture'
                          )
              ...
              get: function () {
                ...
                return (
                  (document.pictureInPictureElement &&
                    document.pictureInPictureElement === e.media) ||
                  e.media.webkitPresentationMode === $i
                )
              }
            },
            {
              ...
              value: function () {
                ...
                return (
                  ('Boolean' !== x.typeOf(document.pictureInPictureEnabled) ||
                    document.pictureInPictureEnabled) &&
                  (('Boolean' === x.typeOf(e.disablePictureInPicture) &&
                    !e.disablePictureInPicture) ||
                    (e.webkitSupportsPresentationMode &&
                      'Function' === x.typeOf(e.webkitSetPresentationMode)))
                )
              }
            },
            {
              ...
              value: function () {
                if (this.config.showIcon && this.isPIPAvailable())
                  return '<xg-icon class="xgplayer-pip">\n      <div class="xgplayer-icon xg-icon-disable">\n      </div>\n      '.concat(
                    Yt(this, 'PIP', this.playerConfig.isHideTips),
                    '\n    </xg-icon>'
                  )
              }
            }
          ...
          [
            ...
            },
            {
              key: 'defaultConfig',
              get: function () {
                return { position: it.CONTROLS_RIGHT, index: 6, showIcon: !1 }
              }
            },
            {
              ...
              value: function () {
                if (this.config.urlList && 0 !== this.config.urlList.length)
                  return '\n     <xg-icon class="xgplayer-playnext">\n      <div class="xgplayer-icon">\n      </div>\n      '.concat(
                    Yt(this, 'PLAYNEXT_TIPS', this.playerConfig.isHideTips),
                    '\n     </xg-icon>\n    '
                  )
              }
            }
  ...
  rn.exports = function e(t, i, n) {
    ...
    if (
      ((o = c instanceof f ? c : new f([c], { type: l })), navigator.msSaveBlob)
    )
        ...
        return (
          ...
          s(u((o = t.call(this, e))), 'download', function (e) {
            if (!o.isLock) {
              ...
              var t = o.playerConfig.url,
                i = ''
              'String' === x.typeOf(t)
                ? (i = t)
                : 'Array' === x.typeOf(t) && t.length > 0 && (i = t[0].src)
              var n = o.getAbsoluteURL(i)
              sn(n),
                (o.isLock = !0),
        ...
        r(
              ...
              value: function () {
                if (!this.config.disable)
                  return '<xg-icon class="xgplayer-download">\n   <div class="xgplayer-icon">\n   </div>\n   '.concat(
                    Yt(this, 'DOWNLOAD_TIPS', this.playerConfig.isHideTips),
                    '\n    </xg-icon>'
                  )
              }
            }
          ...
          [
            ...
            },
            {
              key: 'defaultConfig',
              get: function () {
                return { position: it.CONTROLS_RIGHT, index: 3, disable: !0 }
              }
            }
          ]
        ),
          ...
          [
            {
              key: 'beforeCreate',
              value: function (e) {
                'boolean' == typeof e.player.config.screenShot &&
                  (e.config.disable = !e.player.config.screenShot)
              }
            },
            {
              key: 'afterCreate',
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                ;(this.canvasCtx = n),
                  ...
                  n.imageSmoothingEnabled && (n.imageSmoothingQuality = 'high')
              }
            },
            {
              key: 'onClickBtn',
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                return new Promise(function (n, l) {
                  var c,
                    u = null
                  if (r.media.canvas) u = r.media.canvas
                  else {
                    i.canvas
                      ? ((i.canvas.width = e || o.width),
                        (i.canvas.height = t || o.height))
                      : i.createCanvas(e, t),
                      (u = i.canvas),
                      (c = i.canvasCtx)
                    var h,
                      ...
                      f,
                      p,
                      g = r.media.videoWidth / r.media.videoHeight,
                      v = u.width / u.height,
                      y = r.media.videoWidth,
                      m = r.media.videoHeight
                    g > v
                      ? ((f = u.width),
                        (p = u.width / g),
                        (h = 0),
                        (d = Math.round((u.height - p) / 2)))
                      : g === v
                        ? ((f = u.width), (p = u.height), (h = 0), (d = 0))
                        : g < v &&
                          ((f = u.height * g),
                          (p = u.height),
                          (h = Math.round((u.width - f) / 2)),
                          (d = 0)),
                      c.drawImage(r.media, 0, 0, y, m, h, d, f, p)
                  }
                  var k = u.toDataURL(a, s).replace(a, 'image/octet-stream')
                  n(
                    (k = k.replace(
                      /^data:image\/[^;]+/,
            ...
            },
            {
              ...
              value: function () {
                if (!this.config.disable) {
                  var e = this.icons.screenshotIcon
                      ? 'xgplayer-icon'
                  ...
                  return '\n      <xg-icon class="xgplayer-shot">\n      <div class="'
                    ...
                    .concat(
                      this.icons.screenshotIcon
                        ? ''
                        : '<span lang-key="'
                            .concat(this.i18nKeys[t], '">')
                            .concat(this.i18n[t], '</span>'),
                      '\n      </div>\n    </xg-icon>'
                    )
                }
              }
      ...
      function e(t) {
        n(this, e),
          ...
          (this.root = x.createDom(
            ...
            '',
            {},
            'xg-options-list xg-list-slide-scroll '.concat(
              this.config.className
            )
          )),
          t.root.appendChild(this.root)
        var i = this.config.maxHeight
        i && this.setStyle({ maxHeight: i }),
          (this.onItemClick = this.onItemClick.bind(this)),
          this.renderItemList()
        var o = 'mobile' === O.device ? 'touchend' : 'click'
        this._delegates = st.delegate.call(
          this,
          this.root,
          'li',
          o,
        ...
        r(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              var i =
                  'function' == typeof this.config.onItemClick
                    ? this.config.onItemClick
                    : null,
  ...
  var gn = 'mobile' === O.device,
        ...
        return (
          ...
          s(u((i = t.call(this, e))), 'onEnter', function (e) {
            e.stopPropagation(),
              ...
              i.switchActiveState(e)
          }),
          s(u(i), 'switchActiveState', function (e) {
            e.stopPropagation(),
              i.config.toggleMode === fn ? i.toggle(!i.isActive) : i.toggle(!0)
          }),
          s(u(i), 'onLeave', function (e) {
            e.stopPropagation(),
              i.emit('icon_mouseleave', { pluginName: i.pluginName }),
              i.config.listType !== hn && i.isActive && i.toggle(!1)
          }),
          s(u(i), 'onListEnter', function (e) {
            i.enterType = 2
          }),
          s(u(i), 'onListLeave', function (e) {
            ;(i.enterType = 0), i.isActive && i.toggle(!1)
          }),
          (i.isIcons = !1),
          (i.isActive = !1),
          (i.curValue = null),
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                var e = this,
                  t = this.config
                this.initIcons(),
                  gn && t.listType !== dn && (t.listType = hn),
                  t.hidePortrait && x.addClass(this.root, 'portrait'),
                  this.on([ve, he], function () {
                    e._resizeList()
                  }),
                  this.once(K, function () {
                    t.list &&
                      t.list.length > 0 &&
                      (e.renderItemList(t.list), e.show())
                  }),
                  gn &&
                    this.on(ee, function () {
                      e.isActive &&
                        (e.optionsList && e.optionsList.hide(),
                        (e.isActive = !1))
                    }),
                  gn
                    ? ((t.toggleMode = fn), (this.activeEvent = 'touchend'))
                    : (this.activeEvent =
                        t.toggleMode === fn ? 'click' : 'mouseenter'),
                  t.toggleMode === fn
            ...
            },
            {
              ...
              value: function (e, t, n) {
                ...
                try {
                  return 'object' === i(e[t]) ? e[t][n] || e[t].en : e[t]
                } catch (r) {
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                ;(this.curIndex = t.to.index),
                  ...
                  (this.config.isItemClickHide || gn || n === hn) &&
                    this.toggle(!1)
              }
            },
            { key: 'onIconClick', value: function (e) {} },
            {
              ...
              value: function () {
                if (!this.isIcons) {
                  ...
                  t &&
                    (this.find('.icon-text').innerHTML = this.getTextByLang(
                      t,
                      'iconText'
                    ))
                }
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                if (
                  ('number' == typeof t &&
                    ((this.curIndex = t), (this.curItem = n.list[t])),
                  o)
                )
                ...
                var s,
                  ...
                  l = {
                    ...
                    root:
                      n.listType === hn ? r.innerContainer || r.root : this.root
                  }
                if (this.config.isShowIcon) {
                  var c = this.player.root.getBoundingClientRect().height,
                    u = n.listType === dn ? c - 50 : c
                  u &&
                    n.heightLimit &&
                    (l.config.maxHeight = ''.concat(u, 'px')),
                    (this.optionsList = new un(l)),
                    this.changeCurrentText(),
                    this.show()
                }
                this._resizeList()
              ...
              value: function () {
                if (this.config.heightLimit) {
                  var e = this.player.root.getBoundingClientRect().height,
                    t = this.config.listType === dn ? e - 50 : e
                  this.optionsList &&
                    this.optionsList.setStyle({ maxHeight: ''.concat(t, 'px') })
                }
              }
            },
            {
              ...
              value: function () {
                this.config.toggleMode === fn
                  ...
                  this.optionsList &&
                    (this.optionsList.destroy(), (this.optionsList = null))
              }
            },
            {
              key: 'render',
    ...
    yn = (function (e) {
      ...
      function o(e) {
        var t
        return (
          n(this, o), ((t = i.call(this, e)).curTime = 0), (t.isPaused = !0), t
        )
      }
      return (
        r(
          ...
          [
              ...
              value: function () {
                ...
                var s = 0,
                  a = i.map(function (i, n) {
                    ...
                    return (
                      (i.selected || (i.definition && i.definition == r)) &&
                        ((o.selected = !0), (s = n)),
                      o
                    )
                  })
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                for (var n = 0; n < i.length; n++)
                  t.to &&
                    i[n].definition === t.to.definition &&
                    (t.to.url = i[n].url),
                    t.from &&
                      i[n].definition === t.from.definition &&
                      (t.from.url = i[n].url)
        ...
        r(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                this.config.list &&
                  0 !== this.config.list.length &&
                  p(l(o.prototype), 'show', this).call(this)
              }
            },
            {
              key: 'onItemClick',
              value: function (e, t) {
                ...
                var r = {
                  playbackRate: { from: this.player.playbackRate, to: n }
                }
              ...
              value: function () {
                ...
                p(l(i.prototype), 'afterCreate', this).call(this),
                  this.config.disable ||
                    ...
                    (this.btnClick = this.btnClick.bind(this)),
                    (this.handleCssFullscreen = this.hook(
              ...
              value: function (e) {
                ...
                i &&
                  this.changeLangTextKey(
                    i,
                    e ? t.EXITCSSFULLSCREEN_TIPS : t.CSSFULLSCREEN_TIPS
                  )
              }
            },
            {
              ...
              value: function () {
                return {
                  cssFullscreen: { icon: kn, class: 'xg-get-cssfull' },
                  exitCssFullscreen: { icon: bn, class: 'xg-exit-cssfull' }
                }
              }
            },
            {
              ...
              value: function () {
                ...
                ;(this.find('.xgplayer-error-text').innerHTML = n),
                  (this.find('.xgplayer-error-tips').innerHTML = ''
                    .concat(
                      this.i18n.REFRESH_TIPS,
                      '<span class="xgplayer-error-refresh">'
                    )
  ...
  var Sn = {
    ...
    createDot: function (e) {
      ...
      if (i && (t && (xn(e), this._ispots.push(e)), this.ispotsInit || !t)) {
        ...
        n.isMini && (r += ' mini')
        var s = e.template
            ? '<div class="xgplayer-spot-pop">'.concat(e.template, '</div>')
            : '',
          a = x.createDom(
            'xg-spot',
            s,
        ...
        Object.keys(o).map(function (e) {
          ...
          i.outer && i.outer.appendChild(a),
          this.positionDot(a, e.id)
      }
    },
    findDot: function (e) {
    ...
    deleteAllDots: function () {
      ...
      if (e)
        if (this.ispotsInit) {
          for (
            var t = e.root.getElementsByTagName('xg-spot'), i = t.length - 1;
            i >= 0;
            i--
          )
      ...
      if (i)
        if (this.ispotsInit) {
          ...
          var n = i.root.getElementsByTagName('xg-spot'),
            o = n.length
          if (o > t.length)
            for (var r = o - 1; r > t.length - 1; r--) i.outer.removeChild(n[r])
          t.forEach(function (t, i) {
            i < o
              ? (n[i].setAttribute('data-id', ''.concat(t.id)),
                e._ispots.push(t),
                e.updateDot(t))
              : e.createDot(t)
          })
    ...
    positionDots: function () {
      var e = this,
        t = this._ispots,
        i = this.playerSize,
        n = this.player.sizeInfo,
        o = this.player.plugins.progress
      o &&
        n.width !== i.width &&
        ((i.width = n.width),
        (i.left = n.left),
        t.forEach(function (t) {
          var i = o.find('xg-spot[data-id="'.concat(t.id, '"]'))
          i && e.positionDot(i, t.id)
        }))
    },
    positionDot: function (e, t) {
      var i = x.findDom(e, '.xgplayer-spot-pop')
      if (i) {
        var n = this.playerSize,
          o = e.getBoundingClientRect(),
          r = i.getBoundingClientRect(),
          s = o.left - n.left,
          a = n.width - s - o.width / 2
        if (s < r.width / 2 || n.width < r.width) {
          var l = r.width / 2 - s
          i.style.left = ''.concat(l, 'px')
        } else if (a < r.width / 2) {
          var c = a - r.width / 2 + o.width / 2
      ...
      function i(e) {
        ...
        return (
          ...
          s(u((o = t.call(this, e))), 'onMousemove', function (e) {
            o.config.disable ||
              (x.hasClass(e.target, 'xg-spot-content') &&
              o.config.isHideThumbnailHover
                ? o.player.plugins.progress.onMouseLeave(e)
                : (o._state.f || x.hasClass(e.target, 'xg-spot-content')) &&
                  (x.event(e), e.stopPropagation()))
          }),
          ...
          s(u(o), 'onMouseup', function (e) {
            if (o.isDrag) {
              ...
              t &&
                t.pos &&
                (t.onMouseUp(e), !t.pos.isEnter && t.onMouseLeave(e))
            }
          }),
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                var e = this
                ;(this._curDot = null),
                  (this.handlerSpotClick = this.hook(
                    'spotClick',
                    function (t, i) {
                      i.seekTime && e.player.seek(i.seekTime)
                    }
                  )),
                  (this.transformTimeHook = this.hook(
                    'transformTime',
                    function (t) {
                  ...
                  (function (e) {
                    ...
                    ;(e._ispots = n.map(function (e) {
                      ...
                      (e.ispotsInit = !1),
                      (e.playerSize = {
                        left: i.sizeInfo.left,
                        width: i.sizeInfo.width
                      }),
                      e.on(q, function () {
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  t &&
                  (Object.keys(En).map(function (i) {
                    ;(e[En[i]] = e[En[i]].bind(e)), t.addCallBack(i, e[En[i]])
                  }),
                  'mobile' !== O.device)
                ) {
            ...
            },
            {
              ...
              value: function (e, t) {
                var i = this.root,
                  ...
                  o = this.player,
                  r = this.config,
                  s = 'flex' === o.controls.mode,
                  a = i.getBoundingClientRect().width
                if (a || !this._hasThumnail) {
                  var l,
                    c =
                      e -
                      (a = this._hasThumnail && a < r.width ? r.width : a) / 2
                  c < 0 && !s
                    ? ((c = 0), (l = e - a / 2))
                    : c > t - a && !s
                      ? ((l = c - (t - a)), (c = t - a))
            ...
            },
            {
              ...
              value: function (e) {
                var t = this.timeText,
                  i = this.timePoint
                ;(t.innerHTML = e), !this.thumbnail && (i.innerHTML = e)
              }
            },
            {
              key: 'updatePosition',
              value: function (e, t, i, n) {
                var o = this.root,
                  ...
                  s = this._state
                if (o) {
                  ;(s.now = i), this.transformTimeHook(i)
                  var a = this.timeStr
                  n && n.target && x.hasClass(n.target, 'xgplayer-spot')
                    ? (this.showTips(n.target.getAttribute('data-text'), !1, a),
                      ...
                      r.isFocusDots &&
                        s.f &&
                        (s.now = parseInt(
                          n.target.getAttribute('data-time'),
                          10
                        )))
                    : r.defaultText
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (o && o.usable) {
                  this.thumbnail &&
                    o.update(this.thumbnail, e, n.width, n.height)
                  var r = i && i.getBoundingClientRect()
                  this.videothumbnail &&
                    o.update(this.videothumbnail, e, r.width, r.height)
                }
              }
            },
            {
              ...
              value: function () {
                ...
                if ('mobile' !== O.device) {
                  ...
                  if (
                    (n && n.setConfig(e), n && n.usable && i.isShowThumbnail)
                  ) {
                    ...
                    ;(this.thumbnail = n.createThumbnail(
                      o,
                      'progress-thumbnail'
                    )),
                      i.isShowCoverPreview &&
                        ((this.videoPreview = x.createDom(
                          'xg-video-preview',
                          '',
                          {},
                          'xgvideo-preview'
                        ...
                        (this.videothumbnail = n.createThumbnail(
                          this.videoPreview,
                          'xgvideo-thumbnail'
                        ))),
                ...
                x.addClass(this.root, 'no-timepoint'),
                  e &&
                    ...
                    t && 'production' === this.config.mode
                      ? (x.addClass(this.root, 'product'),
                        (this.tipText.textContent = e))
            ...
            },
            {
              ...
              value: function () {
                ...
                ;(this.config.disable = !1),
                  ...
                  !this.thumbnail &&
                    e.isShowThumbnail &&
                    this.registerThumbnail(t.thumbnail || {})
              }
            },
            {
              key: 'disable',
            ...
            },
            {
              ...
              value: function () {
                ...
                t &&
                  Object.keys(En).map(function (i) {
                    t.removeCallBack(i, e[En[i]])
                  }),
                  (this.videothumbnail = null),
                  (this.thumbnail = null),
                  this.videoPreview &&
                    this.player.root.removeChild(this.videoPreview),
        ...
        r(
          ...
          [
                  ...
                  this.on([q], function () {
                    ...
                    e.usable &&
                      (e.interval =
                        n > 0
                          ? n
                          : Math.round((1e3 * e.player.duration) / i) / 1e3)
                  })
              }
            },
            {
            ...
            },
            {
              key: 'getUrlByIndex',
              value: function (e) {
                return e >= 0 && e < this.config.urls.length
                  ? this.config.urls[e]
                  : ''
              }
            },
        ...
        r(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                if (
                  this.playerConfig.progress &&
                  this.playerConfig.miniprogress
                ) {
                  var e = this.playerConfig.commonStyle,
                    t = {
                      cached: In(e.cachedColor),
                      played: In(e.playedColor),
                      progress: In(e.progressColor)
                    }
                  return '<xg-mini-progress class="xg-mini-progress" style="'
                    .concat(
                      t.progress,
  ...
  var jn = null,
          ...
          s(
            ...
            function (t) {
              e.player &&
                ...
                e.off(W, e.renderOnTimeupdate),
                e.on(W, e.renderOnTimeupdate))
            }
          ),
          s(u(e), 'onVisibilitychange', function (t) {
            'visible' === document.visibilityState
              ? e._checkIfCanStart() && e.start()
              : 'hidden' === document.visibilityState && e.stop()
          }),
          s(u(e), 'renderOnTimeupdate', function (t) {
            if (e._frameCount > 0) e.renderOnce(), e._frameCount--
            else {
              ;(e._isLoaded = !0), e.off(W, e.renderOnTimeupdate)
              var i = e.config.startInterval
              !e.player.paused && e._checkIfCanStart() && e.start(0, i)
            }
          }),
          s(u(e), 'start', function (t, i) {
            var n = e.player.video,
              o = Mn(),
              r = e.checkVideoIsSupport(n)
            r &&
              e.canvasCtx &&
              (i || (i = e.interval),
              e.stop(),
              n.videoWidth &&
                ...
                ((e.videoPI =
                  n.videoHeight > 0
                    ? parseInt((n.videoWidth / n.videoHeight) * 100, 10)
                    : 0),
                (e.config.mode === On || o - e.preTime >= i) &&
                  (n && n.videoWidth && e.update(r, e.videoPI),
                  (e.preTime = o))),
              (e.frameId =
                'timer' === e._loopType
                  ? x.setTimeout(u(e), e.start, i)
                  : x.requestAnimationFrame(e.start)))
          }),
          s(u(e), 'stop', function () {
            e.frameId &&
              ('timer' === e._loopType
                ? x.clearTimeout(u(e), e.frameId)
                : x.cancelAnimationFrame(e.frameId),
              (e.frameId = null))
          }),
          e
        )
          ...
          [
            {
              ...
              value: function () {
                ...
                n ||
                  ...
                  (this._frameCount = 0),
                  (this._loopType =
                    this.config.mode !== On && this.interval >= 1e3
                      ? 'timer'
                      : 'animation'),
                  this.once(se, function () {
                    e.player &&
                  ...
                  o !== Dn &&
                    (o !== Rn &&
                      ...
                      this.on(N, function () {
                        ...
                        e._checkIfCanStart() && e.start(0, t)
                      }),
                      this.on(B, function () {
                        e.stop()
                      })),
                    this.on(X, this.onLoadedData),
                    this.on($, function () {
            ...
            },
            {
              ...
              value: function (e) {
                var t = this
                Object.keys(e).forEach(function (i) {
                  'root' === i && e[i] !== t.config[i]
                    ? t.reRender(e[i])
                    : 'frameRate' === i
                      ? (t.interval = parseInt(1e3 / e[i], 10))
                      : 'disable' === i && e[i] && t.stop(),
                    (t.config[i] = e[i])
                })
              }
            },
            {
              ...
              value: function (e) {
                ...
                try {
                  var o = e || n.root
                  o || (o = (n.isInnerRender && t.innerContainer) || t.root),
                    ...
                    (this.root = o.children[0]),
                    (this.canvas = this.find('canvas')),
                    this.canvasFilter ||
                      ((this.canvas.style.filter = n.filter),
                      (this.canvas.style.webkitFilter = n.filter)),
                    (this.mask = this.find('xgmask')),
                    n.addMask && (this.mask.style.background = n.maskBg),
                    (this.canvasCtx = this.canvas.getContext('2d'))
                } catch (r) {
                  w.logError('plugin:DynamicBg', r)
                }
              }
            },
            {
              key: 'reRender',
              value: function (e) {
                if (this.config.disable || this.root) {
                  this.stop()
                  var t = this.root ? this.root.parentElement : null
                  if ((t !== e && t.removeChild(this.root), e)) {
                    this.init(e), this.renderOnce()
                    var i = this.config.startInterval
                    this._checkIfCanStart() && this.start(0, i)
                  } else this.root = null
                }
              }
            },
            {
              ...
              value: function (e) {
                if (!e) return null
                var t =
                  e && e instanceof window.HTMLVideoElement
                    ? e
                    : e.canvas
                      ? e.canvas
                      : e.flyVideo
                        ? e.flyVideo
                        : null
                if (t && ('safari' !== O.browser || !x.isMSE(t))) return t
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  this._isLoaded && !this.player.paused && e !== Rn && e !== Dn
                )
              }
            },
            {
              ...
              value: function () {
                ...
                if (e.videoWidth && e.videoHeight) {
                  this.videoPI = parseInt(
                    (e.videoWidth / e.videoHeight) * 100,
                    10
                  )
                  var t = this.checkVideoIsSupport(e)
                  t && this.update(t, this.videoPI)
                }
              }
            },
            {
                ...
                if (this.canvas && this.canvasCtx && t)
                  try {
                    ...
                    if (r !== i.width || s !== i.height || i.pi !== t) {
                      ...
                      ;(i.pi = t),
                        i.width !== r && (i.width = this.canvas.width = r),
                        i.height !== s && (i.height = this.canvas.height = s)
                      var l = s,
                        c = r
                      a < t
                        ? (c = parseInt((s * t) / 100, 10))
                        : a > t && (l = parseInt((100 * r) / t, 10)),
    ...
    Bn = (function (e) {
      ...
      function o() {
        ...
        return (
          s(
            u((e = i.call.apply(i, [this].concat(a)))),
            '_recordUserActions',
            function (i) {
              var n = e._getTime(),
                o = Object.assign({}, i, { msg: i.msg || i.action })
              e._stats.info.push(
                t(t({ type: 'userAction' }, n), {}, { payload: o })
              )
            }
          ),
          s(u(e), '_onReset', function () {
        ...
        r(
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                this.reset(),
                  this.on(we, this._recordUserActions),
                  this.on(Hn.STATS_INFO, this._recordInfo),
                  this.on(Hn.STATS_DOWNLOAD, this._downloadStats),
                  this.on(Hn.STATS_RESET, this._onReset)
              }
            },
            {
              key: 'destroy',
            ...
            },
            {
              ...
              value: function () {
                var e
                this._stats = (s((e = {}), Fn, []), s(e, 'media', {}), e)
              }
            },
            {
              key: 'getStats',
              ...
              value: function () {
                return this._stats.info.map(function (e) {
                  ...
                  try {
                    t instanceof Error
                      ? (i = t.msg)
                      : void 0 !== t && (i = JSON.stringify(t))
                  } catch (n) {
                    console.log('err', n)
                  }
                  return '['
                    .concat(e.timeFormat, '] : ')
                    .concat(e.payload.msg, ' ')
                    .concat(i, ' ')
                })
              }
            },
                  ...
                  if (null !== c && 0 !== c) {
                    ...
                    if (!(h > n.media.duration)) {
                      ...
                      d < i.BROWSER_GAP_TOLERANCE ||
                        (f &&
                          (!1 !== o.useGapJump &&
                            (n.media.currentTime = e.isSafari ? h + 0.1 : h),
          ...
          [
            ...
            },
            {
              ...
              value: function (e, t, i) {
                ...
                for (
                  var n = this._getBuffered(e), o = null, r = 0;
                  r < n.length;
                  r++
                ) {
  ...
  Un.BROWSER_GAP_TOLERANCE = 0.001
  var Vn = (function (e) {
      a(i, e)
      var t = d(i)
      function i() {
          ...
          [
            {
              ...
              value: function () {
                ...
                !1 !== i &&
                  ...
                  (this.timer = null),
                  (this.jumpSize = n),
                  this.on(z, this.onWaiting),
                  this.on([F, K], function () {
                    clearTimeout(e.timer),
                      (e.timer = null),
    ...
    zn = (function (e) {
      ...
      function i() {
        ...
        return (
            ...
            function () {
              var t =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
                  : Gn
              if (!e.speedListCache || !e.speedListCache[t]) return 0
              if (e.speedListCache[t].length <= 0) return 0
              var i = 0
              return (
                e.speedListCache[t].map(function (e) {
                  i += e
                }),
          ...
          s(u(e), 'startTimer', function () {
            x.isMSE(e.player.video) ||
              (e.initSpeedList(),
              (e.cnt = 0),
              (e.timer = setTimeout(e.testSpeed, e.config.testTimeStep)))
          }),
          s(u(e), 'initSpeedList', function () {
            ;(e.speedListCache = {}),
          ...
          s(u(e), '_onRealSpeedChange', function (t) {
            t.speed && e.appendList(t.speed, t.type || Gn)
          }),
                  ...
                  ;(u.Range = 'bytes=' + h + '-' + (n + h)),
                    ...
                    (c.onreadystatechange = function () {
                      if (4 === c.readyState) {
                        ...
                        var t =
                            (c.getResponseHeader('Content-Length') / 1024) * 8,
          ...
          s(u(e), 'appendList', function (t) {
            ...
            if (e.speedListCache && e.speedListCache[i]) {
              var n = e.config.saveSpeedMax
              e.speedListCache[i].length >= n && e.speedListCache[i].shift(),
                e.speedListCache[i].push(t)
              var o = u(e),
                r = o.player
              r &&
                (i === Gn
                  ? (r.realTimeSpeed = t)
                  : (r[e.getSpeedName('realTime', i)] = t)),
                e.updateSpeed(i)
            }
          }),
          s(u(e), 'updateSpeed', function () {
            ...
            if (o)
              if (t === Gn)
                (o.avgSpeed && i === o.avgSpeed) ||
                  ((o.avgSpeed = i),
                  o.emit(ue, { speed: i, realTimeSpeed: o.realTimeSpeed }))
              else {
                var r = e.getSpeedName('avg', t)
                ;(o[r] && i === o[r]) ||
                  ((o[r] = i),
                  o.emit(ue, { speed: i, realTimeSpeed: o.realTimeSpeed }))
              }
          ...
          [
            {
              ...
              value: function () {
                var e = this.config,
                  t = e.openSpeed,
                  i = e.addSpeedTypeList
                ;(null == i ? void 0 : i.length) > 0 && Wn.push.apply(Wn, g(i)),
                  this.initSpeedList(),
                  this.on('real_time_speed', this._onRealSpeedChange),
                  (this.timer = null),
                  (this.cnt = 0),
                  (this.xhr = null),
                  t && this.on([X, ae], this.startTimer)
              }
            },
            {
              key: 'getSpeedName',
              value: function (e, t) {
                return e + 'Speed' + t.toUpperCase()
              }
            },
            {
              key: 'openSpeed',
              ...
              value: function () {
                ...
                this.off('real_time_speed', this._onRealSpeedChange),
                  ...
                  this.xhr &&
                    ...
                    (this.xhr.cancel && this.xhr.cancel(), (this.xhr = null))
              }
            }
          ],
          [
        ...
        r(
          ...
          [
            ...
            },
            {
              key: '_checkStuck',
              value: function (e, t, i, n) {
                var o = this.player.media,
                  r = document.hidden,
                  s = o.paused
                if ('boolean' == typeof r && !r && !s) {
                  for (
                    var a = o.currentTime,
                      l = o.buffered,
                      c = !1,
                    ...
                    var d = l.start(h),
                      f = l.end(h)
                    if ((u.push({ start: d, end: f }), d <= a && a <= f - 1)) {
                      c = !0
                      break
                    }
                  }
                  4 === o.readyState &&
                    ...
                    (this._currentStuckCount > this.config.stuckCount
                      ? (this.emit(Le, this._payload), this._reset())
                      : e <= this.config.reportFrame
            ...
            },
            {
              ...
              value: function () {
                if (this.player.media) {
                  var e = this.player.media.getVideoPlaybackQuality(),
                    t = e.totalVideoFrames,
                    i = e.droppedVideoFrames,
                    n = performance.now()
                  if (t && this._lastCheckPoint) {
                    var o = t - this._lastDecodedFrames,
                      r = n - this._lastCheckPoint
                    this._checkStuck(o, t, i, r)
                  }
                  ;(this._lastDecodedFrames = t), (this._lastCheckPoint = n)
                }
              }
            },
            {
  ...
  xt.use({
    ...
    TEXT: {
      ERROR_TYPES: {
        network: { code: 1, msg: '视频下载错误' },
        mse: { code: 2, msg: '流追加错误' },
        parse: { code: 3, msg: '解析错误' },
        format: { code: 4, msg: '格式错误' },
        decoder: { code: 5, msg: '解码错误' },
        runtime: { code: 6, msg: '语法错误' },
        timeout: { code: 7, msg: '播放超时' },
        other: { code: 8, msg: '其他错误' }
      },
  ...
  var qn = r(function e(t, i) {
      var o, r, s
      n(this, e)
      var a = i && 'mobile' === i.isMobileSimulateMode,
        l = i.isLive,
        c = [].concat(l ? [] : [Gi, Di, An, Pn, Vi], [
          ji,
          Ui,
          Xi,
          on,
        ...
        u = [Bt, Ut, Kt, Ii, qt, _n, wn, Ln, si]
      this.plugins = [Bn, Ft].concat(g(c), u, [Un, Vn])
      var h = a ? 'mobile' : O.device
      switch (h) {
        case 'pc':
          ;(o = this.plugins).push.apply(o, [Pi, ci, Cn, zn, Kn])
          break
        case 'mobile':
          ;(r = this.plugins).push.apply(r, [Si])
          break
        default:
          ;(s = this.plugins).push.apply(s, [Pi, ci, Cn])
      }
      ;(O.os.isIpad || 'pc' === h) && this.plugins.push(Nn),
        O.os.isIpad && this.plugins.push(ci),
        (this.ignores = []),
        (this.i18n = [])
    }),
    Yn = (function (e) {
